 ...
 */ const ce = (u, e) => {
  ...
  E = (u, e) => Array.from(u.querySelectorAll(e)),
  Fe = (u, e, t) => {
    t ? u.classList.add(e) : u.classList.remove(e);
  },
  de = (u) => {
    if (typeof u == "string") {
      ...
      if (u === "true") return !0;
      if (u === "false") return !1;
      if (u.match(/^-?[\d.]+$/)) return parseFloat(u);
    }
    return u;
  },
  te = (u, e) => {
  ...
  ke = (u, e) => {
    const t = u.matches || u.matchesSelector || u.msMatchesSelector;
    return !(!t || !t.call(u, e));
  },
  F = (u, e) => {
    if (typeof u.closest == "function") return u.closest(e);
    for (; u; ) {
      if (ke(u, e)) return u;
      u = u.parentNode;
    }
  ...
  wt = () => {
    ...
    location.search.replace(/[A-Z0-9]+?=([\w.%-]*)/gi, (e) => {
      u[e.split("=").shift()] = e.split("=").pop();
    });
    for (const e in u) {
      const t = u[e];
      u[e] = de(unescape(t));
    }
    return u.dependencies !== void 0 && delete u.dependencies, u;
  },
  Bt = {
    mp4: "video/mp4",
    m4a: "video/mp4",
  ...
  he =
    /(iphone|ipod|ipad|android)/gi.test(Ct) ||
    (navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1),
  xt = /android/gi.test(Ct);
var Ht = ((u) => {
  if (u) {
    var e = (h) => [].slice.call(h),
      t = 3,
      i = [],
      s = null,
      a =
        "requestAnimationFrame" in u
          ? () => {
              u.cancelAnimationFrame(s),
                (s = u.requestAnimationFrame(() =>
                  c(i.filter((h) => h.dirty && h.active)),
                ));
            }
          : () => {},
      r = (h) => () => {
        i.forEach((S) => (S.dirty = h)), a();
      },
      c = (h) => {
        h
          .filter((R) => !R.styleComputed)
          .forEach((R) => {
            R.styleComputed = g(R);
          }),
          h.filter(f).forEach(w);
        var S = h.filter(p);
        S.forEach(b),
          S.forEach((R) => {
            w(R), o(R);
      ...
      o = (h) => (h.dirty = 0),
      b = (h) => {
        (h.availableWidth = h.element.parentNode.clientWidth),
          (h.currentWidth = h.element.scrollWidth),
          (h.previousFontSize = h.currentFontSize),
          (h.currentFontSize = Math.min(
            Math.max(
              h.minSize,
              (h.availableWidth / h.currentWidth) * h.previousFontSize,
            ),
            h.maxSize,
          )),
          (h.whiteSpace =
            h.multiLine && h.currentFontSize === h.minSize
              ? "normal"
              : "nowrap");
      },
      p = (h) =>
        h.dirty !== 2 ||
        (h.dirty === 2 &&
          h.element.parentNode.clientWidth !== h.availableWidth),
      g = (h) => {
        var S = u.getComputedStyle(h.element, null);
        return (
          (h.currentFontSize = parseFloat(S.getPropertyValue("font-size"))),
          (h.display = S.getPropertyValue("display")),
          (h.whiteSpace = S.getPropertyValue("white-space")),
          !0
        );
      },
      f = (h) => {
        var S = !1;
        return (
          !h.preStyleTestCompleted &&
          (/inline-/.test(h.display) ||
            ((S = !0), (h.display = "inline-block")),
          h.whiteSpace !== "nowrap" && ((S = !0), (h.whiteSpace = "nowrap")),
          (h.preStyleTestCompleted = !0),
          S)
        );
      },
      w = (h) => {
        (h.element.style.whiteSpace = h.whiteSpace),
          (h.element.style.display = h.display),
          (h.element.style.fontSize = h.currentFontSize + "px");
      },
      C = (h) => {
        h.element.dispatchEvent(
          new CustomEvent("fit", {
            detail: {
              oldValue: h.previousFontSize,
              newValue: h.currentFontSize,
              scaleFactor: h.currentFontSize / h.previousFontSize,
            },
          }),
        );
      },
      l = (h, S) => () => {
        (h.dirty = S), h.active && a();
      },
      $ = (h) => () => {
        (i = i.filter((S) => S.element !== h.element)),
          h.observeMutations && h.observer.disconnect(),
          (h.element.style.whiteSpace = h.originalStyle.whiteSpace),
          (h.element.style.display = h.originalStyle.display),
          (h.element.style.fontSize = h.originalStyle.fontSize);
      },
      M = (h) => () => {
        h.active || ((h.active = !0), a());
      },
      V = (h) => () => (h.active = !1),
      ie = (h) => {
        h.observeMutations &&
          ((h.observer = new MutationObserver(l(h, 1))),
          h.observer.observe(h.element, h.observeMutations));
      },
      D = {
        minSize: 16,
        maxSize: 512,
        multiLine: !0,
        observeMutations: "MutationObserver" in u && {
          subtree: !0,
          childList: !0,
          characterData: !0,
        },
      ...
      A = null,
      I = () => {
        u.clearTimeout(A), (A = u.setTimeout(r(2), L.observeWindowDelay));
      },
      U = ["resize", "orientationchange"];
    return (
      Object.defineProperty(L, "observeWindow", {
        set: (h) => {
          var S = "".concat(h ? "add" : "remove", "EventListener");
          U.forEach((R) => {
            u[S](R, I);
          });
        },
      ...
      (L.observeWindow = !0),
      (L.observeWindowDelay = 100),
      (L.fitAll = r(t)),
      L
    );
  }
  function W(h, S) {
    var R = Object.assign({}, D, S),
      P = h.map((z) => {
        var q = Object.assign({}, R, { element: z, active: !0 });
        return (
          ((H) => {
            (H.originalStyle = {
              whiteSpace: H.element.style.whiteSpace,
              display: H.element.style.display,
              fontSize: H.element.style.fontSize,
            }),
              ie(H),
              (H.newbie = !0),
              (H.dirty = !0),
  ...
  function L(h) {
    ...
    return typeof h == "string"
      ? W(e(document.querySelectorAll(h)), S)
      : W([h], S)[0];
  }
...
class Dt {
  ...
  load(e, t = {}) {
    (e.style.display = this.Reveal.getConfig().display),
      E(
        ...
        (s.tagName !== "IFRAME" || this.shouldPreload(s)) &&
          (s.setAttribute("src", s.getAttribute("data-src")),
          s.setAttribute("data-lazy-loaded", ""),
      ...
      E(e, "video, audio").forEach((s) => {
        ...
        E(s, "source[data-src]").forEach((r) => {
          r.setAttribute("src", r.getAttribute("data-src")),
            ...
            r.setAttribute("data-lazy-loaded", ""),
            (a += 1);
        }),
          he && s.tagName === "VIDEO" && s.setAttribute("playsinline", ""),
          a > 0 && s.load();
      });
    const i = e.slideBackgroundElement;
    if (i) {
      i.style.display = "block";
      const s = e.slideBackgroundContentElement,
        a = e.getAttribute("data-background-iframe");
      if (i.hasAttribute("data-loaded") === !1) {
        i.setAttribute("data-loaded", "true");
        const c = e.getAttribute("data-background-image"),
          o = e.getAttribute("data-background-video"),
          b = e.hasAttribute("data-background-video-loop"),
          p = e.hasAttribute("data-background-video-muted");
        if (c)
          /^data:/.test(c.trim())
            ? (s.style.backgroundImage = `url(${c.trim()})`)
            : (s.style.backgroundImage = c
                .split(",")
                .map(
                  (g) =>
                    `url(${((f = "") =>
                      encodeURI(f)
                        ...
                        .replace(
                          /[!'()*]/g,
                          (w) =>
                            `%${w.charCodeAt(0).toString(16).toUpperCase()}`,
                        ))(decodeURI(g.trim()))})`,
                )
                .join(","));
        else if (o) {
          const g = document.createElement("video");
          b && g.setAttribute("loop", ""),
            (p || this.Reveal.isSpeakerNotes()) && (g.muted = !0),
            he && ((g.muted = !0), g.setAttribute("playsinline", "")),
            o.split(",").forEach((f) => {
              const w = document.createElement("source");
              w.setAttribute("src", f);
              const C = ((l = "") => Bt[l.split(".").pop()])(f);
              C && w.setAttribute("type", C), g.appendChild(w);
            }),
            s.appendChild(g);
        } else if (a && t.excludeIframes !== !0) {
          const g = document.createElement("iframe");
          g.setAttribute("allowfullscreen", ""),
            g.setAttribute("mozallowfullscreen", ""),
            g.setAttribute("webkitallowfullscreen", ""),
            g.setAttribute("allow", "autoplay"),
            g.setAttribute("data-src", a),
            (g.style.width = "100%"),
            (g.style.height = "100%"),
      ...
      const r = s.querySelector("iframe[data-src]");
      r &&
  ...
  unload(e) {
    ...
    const t = this.Reveal.getSlideBackground(e);
    t &&
      ((t.style.display = "none"),
      E(t, "iframe[src]").forEach((i) => {
      ...
      E(e, "video[data-lazy-loaded] source[src], audio source[src]").forEach(
        (i) => {
          i.setAttribute("data-src", i.getAttribute("src")),
            i.removeAttribute("src");
        },
    ...
    if (e) {
      ...
      E(e, 'img[src$=".gif"]').forEach((i) => {
        ...
        E(e, "video, audio").forEach((i) => {
          if (F(i, ".fragment") && !F(i, ".fragment.visible")) return;
          let s = this.Reveal.getConfig().autoPlayMedia;
          if (
            (typeof s != "boolean" &&
              (s =
                i.hasAttribute("data-autoplay") || !!F(i, ".slide-background")),
            s && typeof i.play == "function")
          ) {
            if (t && !i.muted) return;
            if (i.readyState > 1) this.startEmbeddedMedia({ target: i });
            else if (he) {
              const a = i.play();
              a &&
              ...
              i.removeEventListener("loadeddata", this.startEmbeddedMedia),
                i.addEventListener("loadeddata", this.startEmbeddedMedia);
          }
        }),
        t ||
          (E(e, "iframe[src]").forEach((i) => {
            (F(i, ".fragment") && !F(i, ".fragment.visible")) ||
              this.startEmbeddedIframe({ target: i });
          }),
          E(e, "iframe[data-src]").forEach((i) => {
            (F(i, ".fragment") && !F(i, ".fragment.visible")) ||
              (i.getAttribute("src") !== i.getAttribute("data-src") &&
                (i.removeEventListener("load", this.startEmbeddedIframe),
                i.addEventListener("load", this.startEmbeddedIframe),
                i.setAttribute("src", i.getAttribute("data-src"))));
          }));
    }
  }
  startEmbeddedMedia(e) {
    const t = !!F(e.target, "html"),
      i = !!F(e.target, ".present");
    t &&
      i &&
  ...
  startEmbeddedIframe(e) {
    ...
    if (t && t.contentWindow) {
      const i = !!F(e.target, "html"),
        s = !!F(e.target, ".present");
      if (i && s) {
        let a = this.Reveal.getConfig().autoPlayMedia;
        typeof a != "boolean" &&
          (a = t.hasAttribute("data-autoplay") || !!F(t, ".slide-background")),
          /youtube\.com\/embed\//.test(t.getAttribute("src")) && a
            ? t.contentWindow.postMessage(
                '{"event":"command","func":"playVideo","args":""}',
                "*",
              )
            : /player\.vimeo\.com\//.test(t.getAttribute("src")) && a
  ...
  stopEmbeddedContent(e, t = {}) {
    (t = ce({ unloadIframes: !0 }, t)),
      e &&
        e.parentNode &&
        (E(e, "video, audio").forEach((i) => {
          i.hasAttribute("data-ignore") ||
            typeof i.pause != "function" ||
            (i.setAttribute("data-paused-by-reveal", ""), i.pause());
        }),
        E(e, "iframe").forEach((i) => {
          i.contentWindow && i.contentWindow.postMessage("slide:stop", "*"),
            i.removeEventListener("load", this.startEmbeddedIframe);
        }),
        E(e, 'iframe[src*="youtube.com/embed/"]').forEach((i) => {
          !i.hasAttribute("data-ignore") &&
            i.contentWindow &&
            typeof i.contentWindow.postMessage == "function" &&
        ...
        E(e, 'iframe[src*="player.vimeo.com/"]').forEach((i) => {
          !i.hasAttribute("data-ignore") &&
            i.contentWindow &&
            typeof i.contentWindow.postMessage == "function" &&
            i.contentWindow.postMessage('{"method":"pause"}', "*");
        }),
        t.unloadIframes === !0 &&
          E(e, "iframe[data-src]").forEach((i) => {
...
const ne = ".slides section",
  ee = ".slides>section",
  Et = ".slides>section.present>section",
  Ft =
...
class zt {
  ...
  configure(e, t) {
    ...
    e.slideNumber &&
      ...
      (e.showSlideNumber === "all" ||
        (e.showSlideNumber === "speaker" && this.Reveal.isSpeakerNotes())) &&
      (i = "block"),
  ...
  getSlideNumber(e = this.Reveal.getCurrentSlide()) {
    let t,
      ...
      s = "h.v";
    if (typeof i.slideNumber == "function") t = i.slideNumber(e);
    else {
      typeof i.slideNumber == "string" && (s = i.slideNumber),
        /c/.test(s) ||
          this.Reveal.getHorizontalSlides().length !== 1 ||
          (s = "c");
      const r = e && e.dataset.visibility === "uncounted" ? 0 : 1;
      switch (((t = []), s)) {
        case "c":
        ...
        case "c/t":
          t.push(
            this.Reveal.getSlidePastCount(e) + r,
            "/",
            this.Reveal.getTotalSlides(),
          );
          break;
        default: {
          const c = this.Reveal.getIndices(e);
          t.push(c.h + r);
          const o = s === "h/v" ? "/" : ".";
          this.Reveal.isVerticalSlide(e) && t.push(o, c.v + 1);
        }
      }
    }
...
class qt {
  ...
  jump() {
    ...
    if (/^\d+$/.test(t)) {
      ...
      if (i === "c" || i === "c/t") {
        const s = this.Reveal.getSlides()[parseInt(t, 10) - 1];
        s && (e = this.Reveal.getIndices(s));
      }
    }
    return (
      e ||
  ...
  search(e) {
    const t = new RegExp("\\b" + e.trim() + "\\b", "i"),
      i = this.Reveal.getSlides().find((s) => t.test(s.innerText));
  ...
  onKeyDown(e) {
    e.keyCode === 13
      ? this.confirm()
      : e.keyCode === 27 && (this.cancel(), e.stopImmediatePropagation());
  }
  onInput(e) {
    this.jumpAfter(200);
  }
...
const ze = (u) => {
  ...
  const i = u.match(/^rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)$/i);
  if (i)
    return {
      r: parseInt(i[1], 10),
      g: parseInt(i[2], 10),
...
class Ot {
  ...
  create() {
    (this.element.innerHTML = ""),
      ...
      this.Reveal.getHorizontalSlides().forEach((e) => {
        const t = this.createBackground(e, this.element);
  ...
  getContrastClass(e) {
    ...
    if (!i || !ze(i)) {
      ...
      a && a.backgroundColor && (i = a.backgroundColor);
    }
    if (i) {
      const a = ze(i);
      if (a && a.a !== 0)
        return (
          typeof (s = i) == "string" && (s = ze(s)),
  ...
  update(e = !1) {
    let t = this.Reveal.getConfig(),
      ...
      c = t.rtl ? "past" : "future";
    if (
      (Array.from(this.element.childNodes).forEach((b, p) => {
        b.classList.remove("past", "present", "future"),
          p < s.h
            ? b.classList.add(r)
            : p > s.h
              ? b.classList.add(c)
              : (b.classList.add("present"), (a = b)),
          (e || p === s.h) &&
            E(b, ".slide-background").forEach((g, f) => {
              g.classList.remove("past", "present", "future");
              const w = typeof s.v == "number" ? s.v : 0;
              f < w
                ? g.classList.add("past")
                : f > w
                  ? g.classList.add("future")
                  : (g.classList.add("present"), p === s.h && (a = g));
            });
      }),
      this.previousBackground &&
        !this.previousBackground.closest("body") &&
        (this.previousBackground = null),
      a && this.previousBackground)
    ) {
      const b = this.previousBackground.getAttribute("data-background-hash"),
        p = a.getAttribute("data-background-hash");
      if (p && p === b && a !== this.previousBackground) {
        this.element.classList.add("no-transition");
        const g = a.querySelector("video"),
          f = this.previousBackground.querySelector("video");
        if (g && f) {
          const w = g.parentNode;
          f.parentNode.appendChild(g), w.appendChild(f);
        }
      }
    }
    const o = a !== this.previousBackground;
    if (
      (o &&
        this.previousBackground &&
      ...
      const b = a.querySelector(".slide-background-content");
      if (b) {
        const p = b.style.backgroundImage || "";
        /\.gif/i.test(p) &&
          ((b.style.backgroundImage = ""),
          window.getComputedStyle(b).opacity,
          (b.style.backgroundImage = p));
      }
      this.previousBackground = a;
    }
    i &&
      this.bubbleSlideContrastClassToElement(i, this.Reveal.getRevealElement()),
      setTimeout(() => {
  ...
  updateParallax() {
    ...
    if (this.Reveal.getConfig().parallaxBackgroundImage) {
      ...
      r.length === 1
        ? (t = i = parseInt(r[0], 10))
        : ((t = parseInt(r[0], 10)), (i = parseInt(r[1], 10)));
      let c,
        o,
      ...
      (g =
        typeof this.Reveal.getConfig().parallaxBackgroundVertical == "number"
          ...
          : (i - w) / (C - 1)),
        (f = C > 0 ? g * e.v : 0),
        (this.element.style.backgroundPosition = o + "px " + -f + "px");
    }
  }
  destroy() {
    this.element.remove();
...
class Vt {
  ...
  run(e, t) {
    ...
    if (
      ...
      this.autoAnimateStyleSheet = this.autoAnimateStyleSheet || Oe();
      const r = this.getAutoAnimateOptions(t);
      (e.dataset.autoAnimate = "pending"),
        (t.dataset.autoAnimate = "pending"),
        (r.slideDirection = s > a ? "forward" : "backward");
      const c = e.style.display === "none";
      c && (e.style.display = this.Reveal.getConfig().display);
      const o = this.getAutoAnimatableElements(e, t).map((b) =>
        this.autoAnimateElements(b.from, b.to, b.options || {}, r, St++),
      );
      if (
        (c && (e.style.display = "none"),
        t.dataset.autoAnimateUnmatched !== "false" &&
          this.Reveal.getConfig().autoAnimateUnmatched === !0)
      ) {
        const b = 0.8 * r.duration,
          p = 0.2 * r.duration;
        this.getUnmatchedAutoAnimateElements(t).forEach((g) => {
          let f = this.getAutoAnimateOptions(g, r),
            w = "unmatched";
          (f.duration === r.duration && f.delay === r.delay) ||
            ((w = "unmatched-" + St++),
            o.push(
              `[data-auto-animate="running"] [data-auto-animate-target="${w}"] { transition: opacity ${f.duration}s ease ${f.delay}s; }`,
            )),
            (g.dataset.autoAnimateTarget = w);
        }, this),
          o.push(
            `[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${b}s ease ${p}s; }`,
          );
      }
  ...
  reset() {
    E(
      ...
      E(this.Reveal.getRevealElement(), "[data-auto-animate-target]").forEach(
        (e) => {
  ...
  autoAnimateElements(e, t, i, s, a) {
    ...
    const r = this.getAutoAnimateOptions(t, s);
    i.delay !== void 0 && (r.delay = i.delay),
      i.duration !== void 0 && (r.duration = i.duration),
      i.easing !== void 0 && (r.easing = i.easing);
    const c = this.getAutoAnimatableProperties("from", e, i),
      o = this.getAutoAnimatableProperties("to", t, i);
    if (
      (t.classList.contains("fragment") && delete o.styles.opacity,
      i.translate !== !1 || i.scale !== !1)
    ) {
      const g = this.Reveal.getScale(),
        f = {
          x: (c.x - o.x) / g,
          y: (c.y - o.y) / g,
      ...
      (f.x = Math.round(1e3 * f.x) / 1e3),
        (f.y = Math.round(1e3 * f.y) / 1e3),
        (f.scaleX = Math.round(1e3 * f.scaleX) / 1e3),
        (f.scaleX = Math.round(1e3 * f.scaleX) / 1e3);
      const w = i.translate !== !1 && (f.x !== 0 || f.y !== 0),
        C = i.scale !== !1 && (f.scaleX !== 0 || f.scaleY !== 0);
      if (w || C) {
        const l = [];
        w && l.push(`translate(${f.x}px, ${f.y}px)`),
          C && l.push(`scale(${f.scaleX}, ${f.scaleY})`),
          (c.styles.transform = l.join(" ")),
          (c.styles["transform-origin"] = "top left"),
          (o.styles.transform = "none");
      }
    }
    for (const g in o.styles) {
      const f = o.styles[g],
        w = c.styles[g];
      f === w
        ? delete o.styles[g]
        : (f.explicitValue === !0 && (o.styles[g] = f.value),
          w.explicitValue === !0 && (c.styles[g] = w.value));
    }
    let b = "",
      p = Object.keys(o.styles);
    return (
      p.length > 0 &&
        ((c.styles.transition = "none"),
        (o.styles.transition = `all ${r.duration}s ${r.easing} ${r.delay}s`),
        (o.styles["transition-property"] = p.join(", ")),
        (o.styles["will-change"] = p.join(", ")),
        (b =
          '[data-auto-animate-target="' +
          a +
          '"] {' +
          Object.keys(c.styles)
            .map((g) => g + ": " + c.styles[g] + " !important;")
            .join("") +
          '}[data-auto-animate="running"] [data-auto-animate-target="' +
          a +
          '"] {' +
          Object.keys(o.styles)
            .map((g) => g + ": " + o.styles[g] + " !important;")
            .join("") +
          "}")),
      b
    );
  ...
  getAutoAnimateOptions(e, t) {
    ...
    if (((i = ce(i, t)), e.parentNode)) {
      const s = F(e.parentNode, "[data-auto-animate-target]");
  ...
  getAutoAnimatableProperties(e, t, i) {
    ...
    if (i.translate !== !1 || i.scale !== !1) {
      let c;
      if (typeof i.measure == "function") c = i.measure(t);
      else if (s.center) c = t.getBoundingClientRect();
      else {
        const o = this.Reveal.getScale();
        c = {
          x: t.offsetLeft * o,
          y: t.offsetTop * o,
      ...
      (a.x = c.x), (a.y = c.y), (a.width = c.width), (a.height = c.height);
    }
    const r = getComputedStyle(t);
    return (
      (i.styles || s.autoAnimateStyles).forEach((c) => {
        let o;
        typeof c == "string" && (c = { property: c }),
          c.from !== void 0 && e === "from"
            ? (o = { value: c.from, explicitValue: !0 })
            : c.to !== void 0 && e === "to"
              ? (o = { value: c.to, explicitValue: !0 })
              : (c.property === "line-height" &&
                  (o =
                    parseFloat(r["line-height"]) / parseFloat(r["font-size"])),
                isNaN(o) && (o = r[c.property])),
          o !== "" && (a.styles[c.property] = o);
      }),
      a
    );
  }
  getAutoAnimatableElements(e, t) {
    const i = (
      ...
      s = [];
    return i.filter((a, r) => {
      if (s.indexOf(a.to) === -1) return s.push(a.to), !0;
    });
  }
  getAutoAnimatePairs(e, t) {
    ...
    return (
      this.findAutoAnimateMatches(
        ...
        t,
        "[data-id]",
        (a) => a.nodeName + ":::" + a.getAttribute("data-id"),
      ),
      this.findAutoAnimateMatches(
        i,
        e,
        t,
        s,
        (a) => a.nodeName + ":::" + a.textContent.trim(),
      ),
      this.findAutoAnimateMatches(
        i,
        e,
        ...
        (a) =>
          a.nodeName +
          ":::" +
          (a.getAttribute("src") || a.getAttribute("data-src")),
      ),
      this.findAutoAnimateMatches(
        i,
        e,
      ...
      i.forEach((a) => {
        ke(a.from, s)
          ? (a.options = { scale: !1 })
          : ke(a.from, "pre") &&
            ((a.options = { scale: !1, styles: ["width", "height"] }),
            this.findAutoAnimateMatches(
              i,
              a.from,
              a.to,
            ...
            this.findAutoAnimateMatches(
              ...
              (r) => r.getAttribute("data-line-number"),
              {
                scale: !1,
                styles: ["width"],
                measure: this.getLocalBoundingBox.bind(this),
  ...
  findAutoAnimateMatches(e, t, i, s, a, r) {
    const c = {},
      o = {};
    [].slice.call(t.querySelectorAll(s)).forEach((b, p) => {
      const g = a(b);
      typeof g == "string" && g.length && ((c[g] = c[g] || []), c[g].push(b));
    }),
      [].slice.call(i.querySelectorAll(s)).forEach((b, p) => {
        const g = a(b);
        let f;
        if (((o[g] = o[g] || []), o[g].push(b), c[g])) {
          const w = o[g].length - 1,
            C = c[g].length - 1;
          c[g][w]
            ? ((f = c[g][w]), (c[g][w] = null))
            : c[g][C] && ((f = c[g][C]), (c[g][C] = null));
        }
        f && e.push({ from: f, to: b, options: r });
      });
  }
  getUnmatchedAutoAnimateElements(e) {
    return [].slice.call(e.children).reduce((t, i) => {
      ...
      return (
        i.hasAttribute("data-auto-animate-target") || s || t.push(i),
        i.querySelector("[data-auto-animate-target]") &&
          (t = t.concat(this.getUnmatchedAutoAnimateElements(i))),
        t
      );
    }, []);
  }
...
class Ut {
  ...
  activate() {
    ...
    const t = E(this.Reveal.getRevealElement(), ee),
      i = E(this.Reveal.getRevealElement(), ".backgrounds>.slide-background");
    let s;
    ...
    const b = (p, g, f, w) => {
      let C;
      if (o && this.Reveal.shouldAutoAnimateBetween(o, p))
        (C = document.createElement("div")),
          (C.className = "scroll-page-content scroll-auto-animate-page"),
          (C.style.display = "none"),
          o.closest(".scroll-page-content").parentNode.appendChild(C);
      else {
        const l = document.createElement("div");
        if (((l.className = "scroll-page"), r.push(l), w && i.length > g)) {
          const M = i[g],
            V = window.getComputedStyle(M);
          V && V.background
            ? (l.style.background = V.background)
            : s && (l.style.background = s);
        } else s && (l.style.background = s);
        const $ = document.createElement("div");
        ($.className = "scroll-page-sticky"),
          l.appendChild($),
          (C = document.createElement("div")),
          (C.className = "scroll-page-content"),
          $.appendChild(C);
      }
      C.appendChild(p),
        p.classList.remove("past", "future"),
        p.setAttribute("data-index-h", g),
        p.setAttribute("data-index-v", f),
        p.slideBackgroundElement &&
          (p.slideBackgroundElement.remove("past", "future"),
          C.insertBefore(p.slideBackgroundElement, p)),
        (o = p);
    };
    t.forEach((p, g) => {
      this.Reveal.isVerticalStack(p)
        ? p.querySelectorAll("section").forEach((f, w) => {
            b(f, g, w, !0);
          })
        : b(p, g, 0);
    }, this),
      this.createProgressBar(),
      E(this.Reveal.getRevealElement(), ".stack").forEach((p) => p.remove()),
      r.forEach((p) => c.appendChild(p)),
      this.Reveal.slideContent.layout(this.Reveal.getSlidesElement()),
      this.Reveal.layout(),
      this.Reveal.setState(e),
      this.activatedCallbacks.forEach((p) => p()),
      (this.activatedCallbacks = []),
  ...
  createProgressBar() {
    ...
    const e = (i) => {
        let s =
          (i.clientY - this.progressBarInner.getBoundingClientRect().top) /
  ...
  syncPages() {
    const e = this.Reveal.getConfig(),
      ...
      s = e.scrollLayout === "compact",
      a = this.viewportElement.offsetHeight,
      r = t.height * i,
      c = s ? r : a;
    (this.scrollTriggerHeight = s ? r : a),
      this.viewportElement.style.setProperty("--page-height", c + "px"),
      (this.viewportElement.style.scrollSnapType =
        typeof e.scrollSnap == "string" ? `y ${e.scrollSnap}` : ""),
      (this.slideTriggers = []);
    const o = Array.from(
    ...
    (this.pages = o.map((b) => {
      const p = this.createPage({
        pageElement: b,
        slideElement: b.querySelector("section"),
        stickyElement: b.querySelector(".scroll-page-sticky"),
        contentElement: b.querySelector(".scroll-page-content"),
        backgroundElement: b.querySelector(".slide-background"),
        autoAnimateElements: b.querySelectorAll(".scroll-auto-animate-page"),
        autoAnimatePages: [],
      });
      p.pageElement.style.setProperty(
        "--slide-height",
        e.center === !0 ? "auto" : t.height + "px",
      ),
        ...
        this.createFragmentTriggersForPage(p),
        p.autoAnimateElements.length > 0 &&
          this.createAutoAnimateTriggersForPage(p);
      let g = Math.max(p.scrollTriggers.length - 1, 0);
      (g += p.autoAnimatePages.reduce(
        (f, w) => f + Math.max(w.scrollTriggers.length - 1, 0),
        p.autoAnimatePages.length,
      )),
        p.pageElement
      ...
      for (let f = 0; f < g + 1; f++) {
        ...
        (w.className = "scroll-snap-point"),
          (w.style.height = this.scrollTriggerHeight + "px"),
          (w.style.scrollSnapAlign = s ? "center" : "start"),
          p.pageElement.appendChild(w),
          f === 0 && (w.style.marginTop = -this.scrollTriggerHeight + "px");
      }
      return (
        s && p.scrollTriggers.length > 0
          ? ((p.pageHeight = a),
            p.pageElement.style.setProperty("--page-height", a + "px"))
          : ((p.pageHeight = c),
            p.pageElement.style.removeProperty("--page-height")),
        (p.scrollPadding = this.scrollTriggerHeight * g),
        (p.totalHeight = p.pageHeight + p.scrollPadding),
        p.pageElement.style.setProperty(
          "--page-scroll-padding",
          p.scrollPadding + "px",
        ),
        g > 0
          ? ((p.stickyElement.style.position = "sticky"),
            (p.stickyElement.style.top =
              Math.max((a - p.pageHeight) / 2, 0) + "px"))
          : ((p.stickyElement.style.position = "relative"),
            (p.pageElement.style.scrollSnapAlign =
              p.pageHeight < a ? "center" : "start")),
        p
      );
    })),
  ...
  setTriggerRanges() {
    this.totalScrollTriggerCount = this.slideTriggers.reduce(
      (t, i) => t + Math.max(i.page.scrollTriggers.length, 1),
      0,
    );
    let e = 0;
    this.slideTriggers.forEach((t, i) => {
      ...
      t.page.scrollTriggers.forEach((a, r) => {
        a.range = [e + r * s, e + (r + 1) * s];
      }),
        (e = t.range[1]);
    }),
  ...
  syncProgressBar() {
    ...
    (this.progressBarPlayhead.style.height = this.playheadHeight - a + "px"),
      s > 6
        ? this.slideTriggers.forEach((r) => {
            const { page: c } = r;
            (c.progressBarSlide = document.createElement("div")),
              (c.progressBarSlide.className = "scrollbar-slide"),
              (c.progressBarSlide.style.top =
                r.range[0] * this.progressBarHeight + "px"),
              (c.progressBarSlide.style.height =
                (r.range[1] - r.range[0]) * this.progressBarHeight - a + "px"),
              c.progressBarSlide.classList.toggle(
                "has-triggers",
                c.scrollTriggers.length > 0,
              ),
              this.progressBarInner.appendChild(c.progressBarSlide),
              (c.scrollTriggerElements = c.scrollTriggers.map((o, b) => {
                const p = document.createElement("div");
                return (
                  (p.className = "scrollbar-trigger"),
                  (p.style.top =
                    (o.range[0] - r.range[0]) * this.progressBarHeight + "px"),
                  (p.style.height =
                    (o.range[1] - o.range[0]) * this.progressBarHeight -
                    a +
                    "px"),
                  c.progressBarSlide.appendChild(p),
                  b === 0 && (p.style.display = "none"),
                  p
                );
              }));
          })
  ...
  syncScrollPosition() {
    ...
    let c;
    this.slideTriggers.forEach((o) => {
      const { page: b } = o;
      a >= o.range[0] - 2 * t && a <= o.range[1] + 2 * t && !b.loaded
        ? ((b.loaded = !0), this.Reveal.slideContent.load(b.slideElement))
        : b.loaded &&
          ((b.loaded = !1), this.Reveal.slideContent.unload(b.slideElement)),
        a >= o.range[0] && a <= o.range[1]
          ? (this.activateTrigger(o), (c = o.page))
          : o.active && this.deactivateTrigger(o);
    }),
      c &&
        c.scrollTriggers.forEach((o) => {
          r >= o.range[0] && r <= o.range[1]
            ? this.activateTrigger(o)
            : o.active && this.deactivateTrigger(o);
        }),
  ...
  setProgressBarValue(e) {
    this.progressBar &&
      ...
      this.getAllPages()
        .filter((t) => t.progressBarSlide)
        .forEach((t) => {
          t.progressBarSlide.classList.toggle("active", t.active === !0),
            t.scrollTriggers.forEach((i, s) => {
              t.scrollTriggerElements[s].classList.toggle(
                "active",
                t.active === !0 && i.active === !0,
              );
            });
        }),
      this.showProgressBar());
  ...
  activatePage(e) {
    if (!e.active) {
      ...
      (s.style.display = "block"),
        ...
        this.Reveal.setCurrentScrollPage(t, a, r),
...
class Wt {
  ...
  async activate() {
    const e = this.Reveal.getConfig(),
      t = E(this.Reveal.getRevealElement(), ne),
    ...
    await new Promise(requestAnimationFrame),
      Oe("@page{size:" + a + "px " + r + "px; margin: 0px;}"),
      Oe(
    ...
    const b = this.Reveal.getViewportElement();
    let p;
    if (b) {
      const l = window.getComputedStyle(b);
      l && l.background && (p = l.background);
    }
    await new Promise(requestAnimationFrame),
      this.Reveal.layoutSlideContents(c, o),
      await new Promise(requestAnimationFrame);
    const g = t.map((l) => l.scrollHeight),
      f = [],
      w = t[0].parentNode;
    let C = 1;
    t.forEach(function (l, $) {
      if (l.classList.contains("stack") === !1) {
        let M = (a - c) / 2,
          V = (r - o) / 2;
        const ie = g[$];
        let D = Math.max(Math.ceil(ie / r), 1);
        (D = Math.min(D, e.pdfMaxPagesPerSlide)),
          ((D === 1 && e.center) || l.classList.contains("center")) &&
            (V = Math.max((r - ie) / 2, 0));
        const A = document.createElement("div");
        if (
          (f.push(A),
          (A.className = "pdf-page"),
          (A.style.height = (r + e.pdfPageHeightOffset) * D + "px"),
          p && (A.style.background = p),
          A.appendChild(l),
          (l.style.left = M + "px"),
          (l.style.top = V + "px"),
          (l.style.width = c + "px"),
          this.Reveal.slideContent.layout(l),
          l.slideBackgroundElement &&
            A.insertBefore(l.slideBackgroundElement, l),
          e.showNotes)
        ) {
          const I = this.Reveal.getSlideNotes(l);
          if (I) {
            const W = typeof e.showNotes == "string" ? e.showNotes : "inline",
              L = document.createElement("div");
            L.classList.add("speaker-notes"),
              L.classList.add("speaker-notes-pdf"),
              L.setAttribute("data-layout", W),
              (L.innerHTML = I),
              W === "separate-page"
                ? f.push(L)
                : ((L.style.left = "8px"),
                  (L.style.bottom = "8px"),
                  (L.style.width = a - 16 + "px"),
                  A.appendChild(L));
          }
        }
        if (i) {
          const I = document.createElement("div");
          I.classList.add("slide-number"),
            I.classList.add("slide-number-pdf"),
            (I.innerHTML = C++),
            A.appendChild(I);
        }
        if (e.pdfSeparateFragments) {
          const I = this.Reveal.fragments.sort(
            A.querySelectorAll(".fragment"),
            !0,
          );
          let U;
          I.forEach(function (W, L) {
            U &&
              U.forEach((S) => {
                S.classList.remove("current-fragment");
              }),
              W.forEach((S) => {
                S.classList.add("visible", "current-fragment");
              }, this);
            const h = A.cloneNode(!0);
            if (i) {
              const S = L + 1;
              h.querySelector(".slide-number-pdf").innerHTML += "." + S;
            }
            f.push(h), (U = W);
          }, this),
            I.forEach((W) => {
          ...
          E(A, ".fragment:not(.fade-out)").forEach((I) => {
            I.classList.add("visible");
          });
      }
    }, this),
      await new Promise(requestAnimationFrame),
      f.forEach((l) => w.appendChild(l)),
      this.Reveal.slideContent.layout(this.Reveal.getSlidesElement()),
      this.Reveal.dispatchEvent({ type: "pdf-ready" }),
      b.classList.remove("loading-scroll-mode");
  }
  isActive() {
...
class jt {
  ...
  sort(e, t = !1) {
    ...
    let i = [],
      ...
      a = [];
    e.forEach((c) => {
      if (c.hasAttribute("data-fragment-index")) {
        const o = parseInt(c.getAttribute("data-fragment-index"), 10);
        i[o] || (i[o] = []), i[o].push(c);
      } else s.push([c]);
    }),
      (i = i.concat(s));
    ...
    return (
      i.forEach((c) => {
        c.forEach((o) => {
          a.push(o), o.setAttribute("data-fragment-index", r);
        }),
          r++;
      }),
      t === !0 ? i : a
  ...
  update(e, t, i = this.Reveal.getCurrentSlide()) {
    ...
    if (
      ...
      let a = 0;
      if (typeof e != "number") {
        const r = this.sort(i.querySelectorAll(".fragment.visible")).pop();
        r && (e = parseInt(r.getAttribute("data-fragment-index") || 0, 10));
      }
      Array.from(t).forEach((r, c) => {
        if (
          (r.hasAttribute("data-fragment-index") &&
            (c = parseInt(r.getAttribute("data-fragment-index"), 10)),
          (a = Math.max(a, c)),
          c <= e)
        ) {
          const o = r.classList.contains("visible");
          r.classList.add("visible"),
            r.classList.remove("current-fragment"),
            c === e &&
              (this.Reveal.announceStatus(this.Reveal.getStatusText(r)),
              r.classList.add("current-fragment"),
          ...
          r.classList.remove("visible"),
            r.classList.remove("current-fragment"),
            o &&
              (this.Reveal.slideContent.stopEmbeddedContent(r),
              s.hidden.push(r),
              this.Reveal.dispatchEvent({
                target: r,
                type: "hidden",
  ...
  activate() {
    if (
      ...
      (this.active = !0),
        ...
        E(this.Reveal.getRevealElement(), ne).forEach((s) => {
          s.classList.contains("stack") ||
            s.addEventListener("click", this.onSlideClicked, !0);
        });
      const e = 70,
        t = this.Reveal.getComputedSlideSize();
  ...
  layout() {
    this.Reveal.getHorizontalSlides().forEach((e, t) => {
      e.setAttribute("data-index-h", t),
        te(e, "translate3d(" + t * this.overviewSlideWidth + "px, 0, 0)"),
        e.classList.contains("stack") &&
          E(e, "section").forEach((i, s) => {
            i.setAttribute("data-index-h", t),
              i.setAttribute("data-index-v", s),
              te(
                i,
                "translate3d(0, " + s * this.overviewSlideHeight + "px, 0)",
              );
          });
    }),
      Array.from(this.Reveal.getBackgroundsElement().childNodes).forEach(
        (e, t) => {
          te(e, "translate3d(" + t * this.overviewSlideWidth + "px, 0, 0)"),
            E(e, ".slide-background").forEach((i, s) => {
              te(
                i,
                "translate3d(0, " + s * this.overviewSlideHeight + "px, 0)",
              );
  ...
  deactivate() {
    if (this.Reveal.getConfig().overview) {
      (this.active = !1),
        ...
        E(this.Reveal.getRevealElement(), ne).forEach((t) => {
          te(t, ""), t.removeEventListener("click", this.onSlideClicked, !0);
        }),
        E(this.Reveal.getBackgroundsElement(), ".slide-background").forEach(
          (t) => {
            te(t, "");
          },
        ),
  ...
  onSlideClicked(e) {
    if (this.isActive()) {
      ...
      if (
        ...
        const i = parseInt(t.getAttribute("data-index-h"), 10),
          s = parseInt(t.getAttribute("data-index-v"), 10);
...
class $t {
  ...
  onDocumentKeyDown(e) {
    ...
    if (
      (typeof t.keyboardCondition == "function" &&
        t.keyboardCondition(e) === !1) ||
    ...
    const a =
        ...
        document.activeElement.isContentEditable === !0,
      r =
        document.activeElement &&
      ...
      o =
        !(
          ([32, 37, 38, 39, 40, 63, 78, 80, 191].indexOf(e.keyCode) !== -1 &&
            e.shiftKey) ||
          e.altKey
        ) &&
    ...
    if (typeof t.keyboard == "object")
      for (b in t.keyboard)
        t.keyboard[b] === "togglePause" && p.push(parseInt(b, 10));
    if (
      (this.Reveal.isOverlayOpen() &&
        !["Escape", "f", "c", "b", "."].includes(e.key)) ||
      (this.Reveal.isPaused() && p.indexOf(i) === -1)
    )
      return !1;
    let g =
        t.navigationMode === "linear" ||
    ...
    if (typeof t.keyboard == "object") {
      for (b in t.keyboard)
        if (parseInt(b, 10) === i) {
          const w = t.keyboard[b];
          typeof w == "function"
            ? w.apply(null, [e])
            : typeof w == "string" &&
              typeof this.Reveal[w] == "function" &&
              this.Reveal[w].call(),
            (f = !0);
        }
    }
    if (f === !1) {
      for (b in this.bindings)
        if (parseInt(b, 10) === i) {
          const w = this.bindings[b].callback;
          typeof w == "function"
            ? w.apply(null, [e])
            : typeof w == "string" &&
              typeof this.Reveal[w] == "function" &&
    ...
    f === !1 &&
                          ...
                          : i === 70
                            ...
                            : i === 65
                              ...
                              : i === 71
                                ...
                                : i === 67 && this.Reveal.isOverlayOpen()
                                  ? this.Reveal.closeOverlay()
                                  : (i !== 63 && i !== 191) || !e.shiftKey
                                    ? i === 112
      ...
      f
        ...
        : (i !== 27 && i !== 79) ||
          (this.Reveal.closeOverlay() === !1 && this.Reveal.overview.toggle(),
          e.preventDefault && e.preventDefault()),
      this.Reveal.cueAutoSlide();
  }
}
class Xt {
  ...
  getIndicesFromHash(e = window.location.hash, t = {}) {
    ...
    if (/^[0-9]*$/.test(s[0]) || !i.length) {
      ...
      let r,
        c = a.hashOneBasedIndex || t.oneBasedIndex ? 1 : 0,
        o = parseInt(s[0], 10) - c || 0,
        b = parseInt(s[1], 10) - c || 0;
      return (
        a.fragmentInURL && ((r = parseInt(s[2], 10)), isNaN(r) && (r = void 0)),
        { h: o, v: b, f: r }
      );
    }
    {
      ...
      if (a) return { ...this.Reveal.getIndices(a), f: r };
    }
    return null;
  }
  readURL() {
  ...
  getHash(e) {
    ...
    if (
      ...
      const r = this.Reveal.getConfig().hashOneBasedIndex ? 1 : 0;
      (a.h > 0 || a.v > 0 || a.f >= 0) && (t += a.h + r),
        (a.v > 0 || a.f >= 0) && (t += "/" + (a.v + r)),
        a.f >= 0 && (t += "/" + a.f);
    }
    return t;
...
class Yt {
  ...
  render() {
    ...
    (this.element = document.createElement("aside")),
      ...
      this.Reveal.getRevealElement().appendChild(this.element),
      (this.controlsLeft = E(t, ".navigate-left")),
      (this.controlsRight = E(t, ".navigate-right")),
      (this.controlsUp = E(t, ".navigate-up")),
      (this.controlsDown = E(t, ".navigate-down")),
      (this.controlsPrev = E(t, ".navigate-prev")),
      (this.controlsNext = E(t, ".navigate-next")),
      (this.controlsFullscreen = E(t, ".enter-fullscreen")),
  ...
  configure(e, t) {
    (this.element.style.display =
      e.controls &&
      (e.controls !== "speaker-only" || this.Reveal.isSpeakerNotes())
        ? "block"
        : "none"),
  ...
  bind() {
    ...
    xt && (e = ["touchstart"]),
      e.forEach((t) => {
        this.controlsLeft.forEach((i) =>
          i.addEventListener(t, this.onNavigateLeftClicked, !1),
        ),
          this.controlsRight.forEach((i) =>
            i.addEventListener(t, this.onNavigateRightClicked, !1),
          ),
          this.controlsUp.forEach((i) =>
            i.addEventListener(t, this.onNavigateUpClicked, !1),
          ),
          this.controlsDown.forEach((i) =>
            i.addEventListener(t, this.onNavigateDownClicked, !1),
          ),
          this.controlsPrev.forEach((i) =>
            i.addEventListener(t, this.onNavigatePrevClicked, !1),
          ),
          this.controlsNext.forEach((i) =>
            i.addEventListener(t, this.onNavigateNextClicked, !1),
          ),
          this.controlsFullscreen.forEach((i) =>
            i.addEventListener(t, this.onEnterFullscreen, !1),
          );
      });
  }
  unbind() {
  ...
  update() {
    ...
    [
      ...
      i.classList.remove("enabled", "fragmented"),
    ...
    if (t) {
      const i = this.Reveal.fragments.availableRoutes();
      i.prev &&
        this.controlsPrev.forEach((r) => {
          r.classList.add("fragmented", "enabled"),
            r.removeAttribute("disabled");
        }),
        i.next &&
          this.controlsNext.forEach((r) => {
            r.classList.add("fragmented", "enabled"),
              r.removeAttribute("disabled");
          });
      const s = this.Reveal.isVerticalSlide(t),
        a =
          s &&
          t.parentElement &&
          t.parentElement.querySelectorAll(":scope > section").length > 1;
      s && a
        ? (i.prev &&
            this.controlsUp.forEach((r) => {
              r.classList.add("fragmented", "enabled"),
                r.removeAttribute("disabled");
            }),
          i.next &&
            this.controlsDown.forEach((r) => {
              r.classList.add("fragmented", "enabled"),
                r.removeAttribute("disabled");
            }))
        : (i.prev &&
            this.controlsLeft.forEach((r) => {
              r.classList.add("fragmented", "enabled"),
                r.removeAttribute("disabled");
            }),
          i.next &&
            this.controlsRight.forEach((r) => {
              r.classList.add("fragmented", "enabled"),
                r.removeAttribute("disabled");
            }));
    }
    if (this.Reveal.getConfig().controlsTutorial) {
      ...
      !this.Reveal.hasNavigatedVertically() && e.down
        ...
        : (this.controlsDownArrow.classList.remove("highlight"),
          this.Reveal.getConfig().rtl
            ? !this.Reveal.hasNavigatedHorizontally() && e.left && i.v === 0
              ? this.controlsLeftArrow.classList.add("highlight")
              : this.controlsLeftArrow.classList.remove("highlight")
            : !this.Reveal.hasNavigatedHorizontally() && e.right && i.v === 0
  ...
  onNavigateLeftClicked(e) {
    e.preventDefault(),
      ...
      this.Reveal.getConfig().navigationMode === "linear"
        ? this.Reveal.prev()
        : this.Reveal.left();
  }
  ...
  onEnterFullscreen(e) {
    ...
    Lt(t.embedded ? i : i.parentElement);
  }
}
class _t {
  constructor(e) {
  ...
  (t.type = "text/javascript"),
    ...
    typeof e == "function" &&
      ((t.onload = t.onreadystatechange =
        (s) => {
          (s.type === "load" || /loaded|complete/.test(t.readyState)) &&
        ...
        if (
          (t.forEach((r) => {
            (r.condition && !r.condition()) ||
              (r.async ? this.asyncDependencies.push(r) : s.push(r));
          }),
          s.length)
        ) {
          a = s.length;
          const r = (c) => {
            c && typeof c.callback == "function" && c.callback(),
              --a == 0 && this.initPlugins().then(i);
          };
          s.forEach((c) => {
            typeof c.id == "string"
              ? (this.registerPlugin(c), r(c))
              : typeof c.src == "string"
                ? Rt(c.src, () => r(c))
                : (console.warn("Unrecognized plugin format", c), r());
          });
        } else this.initPlugins().then(i);
      })
    );
  }
  initPlugins() {
      ...
      if (i === 0) this.loadAsync().then(e);
        ...
        (s = () => {
          ...
          if (typeof c.init == "function") {
            const o = c.init(this.Reveal);
            o && typeof o.then == "function" ? o.then(a) : a();
          } else a();
        }),
          s();
      }
...
class Qt {
  ...
  update() {
    ...
    e || t
      ? this.Reveal.getSlidesElement().addEventListener(
          "click",
          this.onSlidesClicked,
          !1,
        )
      : this.Reveal.getSlidesElement().removeEventListener(
          "click",
          this.onSlidesClicked,
          !1,
        );
  ...
  previewMedia(e, t, i) {
    if (t !== "image" && t !== "video")
      return void console.warn(
        "Please specify a valid media type to preview (image|video)",
      );
    this.close(),
      (i = i || "scale-down"),
      this.createOverlay("r-overlay-preview"),
    ...
    if (t === "image") {
        ...
        throw new Error("Please specify a valid media type to preview");
      {
        ...
        (a.autoplay = this.dom.dataset.previewAutoplay !== "false"),
          (a.controls = this.dom.dataset.previewControls !== "false"),
          (a.loop = this.dom.dataset.previewLoop === "true"),
          (a.muted = this.dom.dataset.previewMuted === "true"),
          (a.playsInline = !0),
          (a.src = e),
          s.appendChild(a),
          a.addEventListener(
  ...
  showHelp() {
    if (this.Reveal.getConfig().help) {
      ...
      for (const s in t) e += `<tr><td>${s}</td><td>${t[s]}</td></tr>`;
      for (const s in i)
        i[s].key &&
          i[s].description &&
          (e += `<tr><td>${i[s].key}</td><td>${i[s].description}</td></tr>`);
      (e += "</table>"),
  ...
  onSlidesClicked(e) {
    ...
    if (i) {
      ...
      const a = i.getAttribute("href") || i.getAttribute("data-preview-link");
      a && (this.previewIframe(a), e.preventDefault());
    } else if (s) {
      if (s.hasAttribute("data-preview-image")) {
        const a = s.dataset.previewImage || s.getAttribute("src");
...
class Zt {
  ...
  isSwipePrevented(e) {
    if (ke(e, "video[controls], audio[controls]")) return !0;
  ...
  onTouchMove(e) {
    ...
    const t = this.Reveal.getConfig();
    if (this.touchCaptured) xt && e.preventDefault();
    else {
      this.Reveal.onUserInput(e);
      ...
      if (e.touches.length === 1 && this.touchStartCount !== 2) {
        const a = this.Reveal.availableRoutes({ includeFragments: !0 }),
          r = i - this.touchStartX,
          c = s - this.touchStartY;
        r > 40 && Math.abs(r) > Math.abs(c)
...
class ti {
  ...
  configure(e, t) {
    e.showNotes &&
      this.element.setAttribute(
        "data-layout",
        typeof e.showNotes == "string" ? e.showNotes : "inline",
      );
  }
  update() {
...
class ii {
  ...
  render() {
    ...
    const r = -Math.PI / 2 + e * (2 * Math.PI),
      c = -Math.PI / 2 + this.progressOffset * (2 * Math.PI);
    this.context.save(),
...
function Tt(u, e) {
  arguments.length < 2 &&
    ((e = arguments[0]), (u = document.querySelector(".reveal")));
  const t = {};
  let i,
    s,
    a,
    ...
    b = !1,
    p = !1,
    g = { hasNavigatedHorizontally: !1, hasNavigatedVertically: !1 },
    f = [],
    w = 1,
    C = { layout: "", overview: "" },
    l = {},
  ...
  function Nt() {
    b !== !1 &&
      ((p = !0),
      o.showHiddenSlides ||
        E(l.wrapper, 'section[data-visibility="hidden"]').forEach((n) => {
          const d = n.parentNode;
          d.childElementCount === 1 && /section/i.test(d.nodeName)
            ? d.remove()
            : n.remove();
        }),
      (() => {
        l.slides.classList.add("no-transition"),
          he
            ? l.wrapper.classList.add("no-hover")
            : l.wrapper.classList.remove("no-hover"),
          L.render(),
          I.render(),
          U.render(),
          H.render(),
          J.render(),
          X.render(),
          (l.pauseOverlay = ((n, d, v, m = "") => {
            const y = n.querySelectorAll("." + v);
            for (let x = 0; x < y.length; x++) {
              const T = y[x];
              if (T.parentNode === n) return T;
            }
            const k = document.createElement(d);
            return (k.className = v), (k.innerHTML = m), n.appendChild(k), k;
          })(
            l.wrapper,
            "div",
            "pause-overlay",
          ...
          (l.statusElement = (() => {
            ...
            return (
              n ||
                ...
                n.classList.add("aria-status"),
                n.setAttribute("aria-live", "polite"),
                n.setAttribute("aria-atomic", "true"),
                l.wrapper.appendChild(n)),
              n
            );
          })()),
          l.wrapper.setAttribute("role", "application");
      })(),
      o.postMessage && window.addEventListener("message", vt, !1),
      setInterval(() => {
        ((!h.isActive() && l.wrapper.scrollTop !== 0) ||
          l.wrapper.scrollLeft !== 0) &&
          ((l.wrapper.scrollTop = 0), (l.wrapper.scrollLeft = 0));
      }, 1e3),
      document.addEventListener("fullscreenchange", Re),
      document.addEventListener("webkitfullscreenchange", Re),
      Z().forEach((n) => {
        E(n, "section").forEach((d, v) => {
          v > 0 &&
            (d.classList.remove("present"),
            d.classList.remove("past"),
      ...
      L.update(!0),
      (() => {
        const n = o.view === "print",
          d = o.view === "scroll" || o.view === "reader";
        (n || d) &&
          (n ? me() : Le.unbind(),
          l.viewport.classList.add("loading-scroll-mode"),
          n
      ...
      q.readURL(),
      setTimeout(() => {
        l.slides.classList.remove("no-transition"),
          l.wrapper.classList.add("ready"),
          K({ type: "ready", data: { indexh: i, indexv: s, currentSlide: r } });
      }, 1));
  }
  function Ce(n) {
  ...
  function pe(n) {
    let d = "";
    if (n.nodeType === 3) d += n.textContent;
    else if (n.nodeType === 1) {
      const v = n.getAttribute("aria-hidden"),
        m = window.getComputedStyle(n).display === "none";
      v === "true" ||
        m ||
        Array.from(n.childNodes).forEach((y) => {
          d += pe(y);
        });
    }
    return (d = d.trim()), d === "" ? "" : d + " ";
  ...
  function Ue(n) {
    const d = { ...o };
    if ((typeof n == "object" && ce(o, n), t.isReady() === !1)) return;
    const v = l.wrapper.querySelectorAll(ne).length;
    l.wrapper.classList.remove(d.transition),
      l.wrapper.classList.add(o.transition),
      l.wrapper.setAttribute("data-transition-speed", o.transitionSpeed),
      l.wrapper.setAttribute(
        "data-background-transition",
        o.backgroundTransition,
      ),
      l.viewport.style.setProperty(
        "--slide-width",
      ...
      o.shuffle && Ne(),
      Fe(l.wrapper, "embedded", o.embedded),
      Fe(l.wrapper, "rtl", o.rtl),
      Fe(l.wrapper, "center", o.center),
      o.pause === !1 && ge(),
      W.reset(),
      c && (c.destroy(), (c = null)),
      v > 1 &&
        o.autoSlide &&
        o.autoSlideStoppable &&
        ((c = new ii(l.wrapper, () =>
          Math.min(Math.max((Date.now() - ie) / M, 0), 1),
        )),
        c.on("click", It),
        (D = !1)),
      o.navigationMode !== "default"
        ? l.wrapper.setAttribute("data-navigation-mode", o.navigationMode)
        : l.wrapper.removeAttribute("data-navigation-mode"),
      X.configure(o, d),
      se.configure(o, d),
      Ve.configure(o, d),
      H.configure(o, d),
  ...
  function We() {
    window.addEventListener("resize", ft, !1),
      o.touch && Le.bind(),
      o.keyboard && z.bind(),
      o.progress && J.bind(),
      o.respondToHashChanges && q.bind(),
      H.bind(),
      se.bind(),
      l.slides.addEventListener("click", mt, !1),
      l.slides.addEventListener("transitionend", pt, !1),
      l.pauseOverlay.addEventListener("click", ge, !1),
      o.focusBodyOnPageVisibilityChange &&
        document.addEventListener("visibilitychange", yt, !1);
  }
  function me() {
    Le.unbind(),
      se.unbind(),
      ...
      J.unbind(),
      q.unbind(),
      window.removeEventListener("resize", ft, !1),
      l.slides.removeEventListener("click", mt, !1),
      l.slides.removeEventListener("transitionend", pt, !1),
      l.pauseOverlay.removeEventListener("click", ge, !1);
  }
  function je(n, d, v) {
    u.addEventListener(n, d, v);
  }
  function Ke(n, d, v) {
    u.removeEventListener(n, d, v);
  }
  function xe(n) {
    typeof n.layout == "string" && (C.layout = n.layout),
      typeof n.overview == "string" && (C.overview = n.overview),
      C.layout
        ? te(l.slides, C.layout + " " + C.overview)
        : te(l.slides, C.overview);
  }
  function K({ target: n = l.wrapper, type: d, data: v, bubbles: m = !0 }) {
    const y = document.createEvent("HTMLEvents", 1, 2);
    return (
      y.initEvent(d, m, !0),
      ce(y, v),
      n.dispatchEvent(y),
  ...
  function Xe(n, d) {
    if (o.postMessageEvents && window.parent !== window.self) {
      const v = { namespace: "reveal", eventName: n, state: ut() };
      ce(v, d), window.parent.postMessage(JSON.stringify(v), "*");
    }
  }
  function oe() {
    if (l.wrapper && !S.isActive()) {
      const n = l.viewport.offsetWidth,
        d = l.viewport.offsetHeight;
      if (!o.disableLayout) {
        he &&
          !o.embedded &&
        ...
        const v = h.isActive() ? fe(n, d) : fe(),
          m = w;
        Ye(o.width, o.height),
          (l.slides.style.width = v.width + "px"),
          (l.slides.style.height = v.height + "px"),
          (w = Math.min(
            v.presentationWidth / v.width,
            v.presentationHeight / v.height,
          )),
          (w = Math.max(w, o.minScale)),
          (w = Math.min(w, o.maxScale)),
          w === 1 || h.isActive()
            ? ((l.slides.style.zoom = ""),
              (l.slides.style.left = ""),
              (l.slides.style.top = ""),
              (l.slides.style.bottom = ""),
              (l.slides.style.right = ""),
              xe({ layout: "" }))
            : ((l.slides.style.zoom = ""),
              (l.slides.style.left = "50%"),
              (l.slides.style.top = "50%"),
              (l.slides.style.bottom = "auto"),
              (l.slides.style.right = "auto"),
              xe({ layout: "translate(-50%, -50%) scale(" + w + ")" }));
        const y = Array.from(l.wrapper.querySelectorAll(ne));
        for (let k = 0, x = y.length; k < x; k++) {
          const T = y[k];
          T.style.display !== "none" &&
            (o.center || T.classList.contains("center")
              ? T.classList.contains("stack")
                ? (T.style.top = 0)
                : (T.style.top =
                    Math.max((v.height - T.scrollHeight) / 2, 0) + "px")
              : (T.style.top = ""));
        }
        m !== w &&
          K({ type: "resize", data: { oldScale: m, scale: w, size: v } });
      }
      (() => {
        if (
          l.wrapper &&
          !o.disableLayout &&
          !S.isActive() &&
          typeof o.scrollActivationWidth == "number" &&
          o.view !== "scroll"
        ) {
          const v = fe();
          v.presentationWidth > 0 &&
          v.presentationWidth <= o.scrollActivationWidth
            ? h.isActive() || (L.create(), h.activate())
            : h.isActive() && h.deactivate();
        }
      })(),
        l.viewport.style.setProperty("--slide-scale", w),
        l.viewport.style.setProperty("--viewport-width", n + "px"),
        l.viewport.style.setProperty("--viewport-height", d + "px"),
        h.layout(),
        J.update(),
        L.updateParallax(),
        P.isActive() && P.update();
    ...
    E(l.slides, "section > .stretch, section > .r-stretch").forEach((v) => {
      const m = ((y, k = 0) => {
        if (y) {
          ...
          return (
            (y.style.height = "0px"),
            (y.parentNode.style.height = "auto"),
            (x = k - y.parentNode.offsetHeight),
            (y.style.height = T + "px"),
            y.parentNode.style.removeProperty("height"),
            x
          );
        }
        return k;
      ...
      if (/(img|video)/gi.test(v.nodeName)) {
        const y = v.naturalWidth || v.videoWidth,
          k = v.naturalHeight || v.videoHeight,
          x = Math.min(n / y, m / k);
        (v.style.width = y * x + "px"), (v.style.height = k * x + "px");
      } else (v.style.width = n + "px"), (v.style.height = m + "px");
    });
  }
  function fe(n, d) {
    let v = o.width,
      m = o.height;
    o.disableLayout &&
      ((v = l.slides.offsetWidth), (m = l.slides.offsetHeight));
    const y = {
      width: v,
      height: m,
    ...
    return (
      (y.presentationWidth -= y.presentationWidth * o.margin),
      (y.presentationHeight -= y.presentationHeight * o.margin),
      typeof y.width == "string" &&
        /%$/.test(y.width) &&
        (y.width = (parseInt(y.width, 10) / 100) * y.presentationWidth),
      typeof y.height == "string" &&
        /%$/.test(y.height) &&
        (y.height = (parseInt(y.height, 10) / 100) * y.presentationHeight),
      y
    );
  }
  function _e(n, d) {
    typeof n == "object" &&
      ...
      n.setAttribute("data-previous-indexv", d || 0);
  }
  function Je(n) {
    if (
      typeof n == "object" &&
      ...
      const d = n.hasAttribute("data-start-indexv")
        ? "data-start-indexv"
  ...
  function Ze() {
    if (o.pause) {
      ...
      ye(),
        l.wrapper.classList.add("paused"),
        n === !1 && K({ type: "paused" });
    }
  }
  function ge() {
    const n = l.wrapper.classList.contains("paused");
    l.wrapper.classList.remove("paused"), le(), n && K({ type: "resumed" });
  }
  function et(n) {
    typeof n == "boolean" ? (n ? Ze() : ge()) : ve() ? ge() : Ze();
  }
  function ve() {
  ...
  function _(n, d, v, m) {
    if (
      ...
      return;
    a = r;
    const y = l.wrapper.querySelectorAll(ee);
    if (h.isActive()) {
      const j = h.getSlideByIndices(n, d);
      return void (j && h.scrollToSlide(j));
    }
    if (y.length === 0) return;
    d !== void 0 || P.isActive() || (d = Je(y[n])),
      a &&
        a.parentNode &&
        a.parentNode.classList.contains("stack") &&
        _e(a.parentNode, s);
    const k = f.concat();
    f.length = 0;
    const x = i || 0,
      T = s || 0;
    (i = it(ee, n === void 0 ? i : n)), (s = it(Et, d === void 0 ? s : d));
    const Q = i !== x || s !== T;
    Q || (a = null);
    const ae = y[i],
      O = ae.querySelectorAll("section");
    u.classList.toggle("is-vertical-slide", O.length > 1), (r = O[s] || ae);
    let N = !1;
    Q &&
      a &&
      r &&
      ...
      (($ = "running"),
      (N = Te(a, r, x, T)),
      N && l.slides.classList.add("disable-slide-transitions")),
      Ie(),
      oe(),
      P.isActive() && P.update(),
      v !== void 0 && R.goto(v),
      a &&
        ...
        Qe() &&
          setTimeout(() => {
            E(l.wrapper, ee + ".stack").forEach((j) => {
              _e(j, 0);
            });
          }, 0));
    e: for (let j = 0, Mt = f.length; j < Mt; j++) {
      for (let Ae = 0; Ae < k.length; Ae++)
        if (k[Ae] === f[j]) {
          k.splice(Ae, 1);
          continue e;
        }
      l.viewport.classList.add(f[j]), K({ type: f[j] });
    }
    for (; k.length; ) l.viewport.classList.remove(k.pop());
    Q && $e(m),
      (!Q && a) || (A.stopEmbeddedContent(a), A.startEmbeddedContent(r)),
      requestAnimationFrame(() => {
        Ce(pe(r));
      }),
      J.update(),
      ...
      N &&
        ...
        o.autoAnimate && W.run(a, r));
  }
  function Te(n, d, v, m) {
    return (
      n.hasAttribute("data-auto-animate") &&
      d.hasAttribute("data-auto-animate") &&
      n.getAttribute("data-auto-animate-id") ===
        d.getAttribute("data-auto-animate-id") &&
      !(i > v || s > m ? d : n).hasAttribute("data-auto-animate-restart")
    );
  }
  function tt() {
    me(),
      ...
      L.create(),
      q.writeURL(),
      o.sortFragmentsOnSync === !0 && R.sortAll(),
      H.update(),
      J.update(),
      Ie(),
      X.update(),
      ...
      L.update(!0),
      I.update(),
      A.formatEmbeddedContent(),
      o.autoPlayMedia === !1
        ? A.stopEmbeddedContent(r, { unloadIframes: !1 })
        : A.startEmbeddedContent(r),
      P.isActive() && P.layout();
  }
  function Ne(n = Z()) {
    n.forEach((d, v) => {
      ...
      const y = d.querySelectorAll("section");
      y.length && Ne(y);
    });
  }
  function it(n, d) {
    let v = E(l.wrapper, n),
      m = v.length,
      y = h.isActive() || S.isActive(),
      k = !1,
      x = !1;
    if (m) {
      o.loop && (d >= m && (k = !0), (d %= m) < 0 && ((d = m + d), (x = !0))),
        (d = Math.max(Math.min(d, m - 1), 0));
      for (let O = 0; O < m; O++) {
        const N = v[O],
          j = o.rtl && !ue(N);
        N.classList.remove("past"),
          ...
          y
            ...
            : O < d
              ? (N.classList.add(j ? "future" : "past"), o.fragments && st(N))
              : O > d
                ? (N.classList.add(j ? "past" : "future"), o.fragments && at(N))
                : O === d && o.fragments && (k ? at(N) : x && st(N));
      }
      const T = v[d],
        Q = T.classList.contains("present");
      T.classList.add("present"),
        T.removeAttribute("hidden"),
        T.removeAttribute("aria-hidden"),
        Q || K({ target: T, type: "visible", bubbles: !1 });
      const ae = T.getAttribute("data-state");
      ae && (f = f.concat(ae.split(" ")));
    } else d = 0;
    return d;
  }
  function st(n) {
  ...
  function Ie() {
    let n,
      ...
      m = v.length;
    if (m && i !== void 0) {
      let y = P.isActive() ? 10 : o.viewDistance;
      he && (y = P.isActive() ? 6 : o.mobileViewDistance),
        S.isActive() && (y = Number.MAX_VALUE);
      for (let k = 0; k < m; k++) {
        const x = v[k],
          T = E(x, "section"),
          Q = T.length;
        if (
          ((n = Math.abs((i || 0) - k) || 0),
          o.loop && (n = Math.abs(((i || 0) - k) % (m - y)) || 0),
          n < y ? A.load(x) : A.unload(x),
          Q)
        ) {
          const ae = Je(x);
          for (let O = 0; O < Q; O++) {
            const N = T[O];
            (d = Math.abs(k === (i || 0) ? (s || 0) - O : O - ae)),
              n + d < y ? A.load(N) : A.unload(N);
          }
        }
      }
      dt()
        ? l.wrapper.classList.add("has-vertical-slides")
        : l.wrapper.classList.remove("has-vertical-slides"),
        lt()
          ? l.wrapper.classList.add("has-horizontal-slides")
          : l.wrapper.classList.remove("has-horizontal-slides");
    }
  }
  function G({ includeFragments: n = !1 } = {}) {
    const d = l.wrapper.querySelectorAll(ee),
      v = l.wrapper.querySelectorAll(Et),
      m = {
        left: i > 0,
        right: i < d.length - 1,
        up: s > 0,
    ...
    if (
      (o.loop &&
        (d.length > 1 && ((m.left = !0), (m.right = !0)),
        v.length > 1 && ((m.up = !0), (m.down = !0))),
      d.length > 1 &&
        o.navigationMode === "linear" &&
        ((m.right = m.right || m.down), (m.left = m.left || m.up)),
      n === !0)
    ) {
      const y = R.availableRoutes();
      (m.left = m.left || y.prev),
        (m.up = m.up || y.prev),
        (m.down = m.down || y.next),
        (m.right = m.right || y.next);
    }
    if (o.rtl) {
      const y = m.left;
      (m.left = m.right), (m.right = y);
    }
    return m;
  }
  function rt(n = r) {
    ...
    e: for (let m = 0; m < d.length; m++) {
      const y = d[m],
        k = y.querySelectorAll("section");
      for (let x = 0; x < k.length; x++) {
        if (k[x] === n) break e;
        k[x].dataset.visibility !== "uncounted" && v++;
      }
      if (y === n) break;
      y.classList.contains("stack") === !1 &&
        y.dataset.visibility !== "uncounted" &&
        v++;
    }
    return v;
  }
  function nt(n) {
    ...
    if (n)
      if (h.isActive())
        (v = parseInt(n.getAttribute("data-index-h"), 10)),
          n.getAttribute("data-index-v") &&
            (m = parseInt(n.getAttribute("data-index-v"), 10));
      else {
        const y = ue(n),
          k = y ? n.parentNode : n,
          x = Z();
        (v = Math.max(x.indexOf(k), 0)),
          (m = void 0),
          y && (m = Math.max(E(n.parentNode, "section").indexOf(n), 0));
      }
    if (!n && r && r.querySelectorAll(".fragment").length > 0) {
      const y = r.querySelector(".current-fragment");
      d =
        y && y.hasAttribute("data-fragment-index")
          ? parseInt(y.getAttribute("data-fragment-index"), 10)
          : r.querySelectorAll(".fragment.visible").length - 1;
    }
    return { h: v, v: m, f: d };
  }
  function Me() {
    return E(l.wrapper, ne + ':not(.stack):not([data-visibility="uncounted"])');
  }
  function Z() {
    return E(l.wrapper, ee);
  }
  function ot() {
  ...
  function ht(n, d) {
    const v = Z()[n],
      m = v && v.querySelectorAll("section");
  ...
  function le() {
    if ((ye(), r && o.autoSlide !== !1)) {
      const n = r.querySelector(".current-fragment[data-autoslide]"),
        d = n ? n.getAttribute("data-autoslide") : null,
        v = r.parentNode ? r.parentNode.getAttribute("data-autoslide") : null,
        m = r.getAttribute("data-autoslide");
      d
        ? (M = parseInt(d, 10))
        : m
          ? (M = parseInt(m, 10))
          : v
            ? (M = parseInt(v, 10))
            : ((M = o.autoSlide),
              r.querySelectorAll(".fragment").length === 0 &&
                E(r, "video, audio").forEach((y) => {
                  y.hasAttribute("data-autoplay") &&
                    M &&
                    (1e3 * y.duration) / y.playbackRate > M &&
                    (M = (1e3 * y.duration) / y.playbackRate + 1e3);
                })),
        !M ||
          D ||
          ve() ||
          P.isActive() ||
          (Pe() && !R.availableRoutes().next && o.loop !== !0) ||
          ((V = setTimeout(() => {
            typeof o.autoSlideMethod == "function" ? o.autoSlideMethod() : De(),
              le();
          }, M)),
          (ie = Date.now())),
        c && c.setPlaying(V !== -1);
  ...
  function be() {
    M &&
      !D &&
      ((D = !0),
      K({ type: "autoslidepaused" }),
      clearTimeout(V),
      c && c.setPlaying(!1));
  }
  function we() {
    M && D && ((D = !1), K({ type: "autoslideresumed" }), le());
  }
  function Ee({ skipFragments: n = !1 } = {}) {
    if (((g.hasNavigatedHorizontally = !0), h.isActive())) return h.prev();
    o.rtl
      ? (P.isActive() || n || R.next() === !1) &&
        G().left &&
        _(i + 1, o.navigationMode === "grid" ? s : void 0)
      : (P.isActive() || n || R.prev() === !1) &&
        G().left &&
        _(i - 1, o.navigationMode === "grid" ? s : void 0);
  }
  function Se({ skipFragments: n = !1 } = {}) {
    if (((g.hasNavigatedHorizontally = !0), h.isActive())) return h.next();
    o.rtl
      ? (P.isActive() || n || R.prev() === !1) &&
        G().right &&
        _(i - 1, o.navigationMode === "grid" ? s : void 0)
  ...
  function Be({ skipFragments: n = !1 } = {}) {
    if (h.isActive()) return h.prev();
    (P.isActive() || n || R.prev() === !1) && G().up && _(i, s - 1);
  }
  function He({ skipFragments: n = !1 } = {}) {
    if (((g.hasNavigatedVertically = !0), h.isActive())) return h.next();
    (P.isActive() || n || R.next() === !1) && G().down && _(i, s + 1);
  }
  function gt({ skipFragments: n = !1 } = {}) {
    if (h.isActive()) return h.prev();
    if (n || R.prev() === !1)
      if (G().up) Be({ skipFragments: n });
      else {
        let d;
        if (
          ((d = o.rtl
            ? E(l.wrapper, ee + ".future").pop()
            : E(l.wrapper, ee + ".past").pop()),
          d && d.classList.contains("stack"))
        ) {
          const v = d.querySelectorAll("section").length - 1 || void 0;
          _(i - 1, v);
        } else o.rtl ? Se({ skipFragments: n }) : Ee({ skipFragments: n });
      }
  }
  function De({ skipFragments: n = !1 } = {}) {
    if (
      ((g.hasNavigatedHorizontally = !0),
      (g.hasNavigatedVertically = !0),
      h.isActive())
    )
      return h.next();
    if (n || R.next() === !1) {
      const d = G();
      d.down && d.right && o.loop && Ge() && (d.down = !1),
        d.down
          ? He({ skipFragments: n })
          : o.rtl
            ? Ee({ skipFragments: n })
  ...
  function vt(n) {
    ...
    if (
      ...
      d.charAt(0) === "{" &&
      d.charAt(d.length - 1) === "}" &&
      ((d = JSON.parse(d)), d.method && typeof t[d.method] == "function")
    )
      if (Ft.test(d.method) === !1) {
        const v = t[d.method].apply(t, d.args);
        Xe("callback", { method: d.method, result: v });
      } else
        console.warn(
          'reveal.js: "' +
            d.method +
  ...
  function pt(n) {
    $ === "running" &&
      /section/gi.test(n.target.nodeName) &&
      (($ = "idle"),
      K({
        type: "slidetransitionend",
        data: { indexh: i, indexv: s, previousSlide: a, currentSlide: r },
      }));
  }
  function mt(n) {
    const d = F(n.target, 'a[href^="#"]');
    if (d) {
      const v = d.getAttribute("href"),
        m = q.getIndicesFromHash(v);
      m && (t.slide(m.h, m.v, m.f), n.preventDefault());
    }
  }
  function ft(n) {
    oe();
  ...
  function It(n) {
    Pe() && o.loop === !1 ? (_(0, 0), we()) : D ? we() : be();
  }
  const bt = {
    VERSION: Pt,
    initialize: (n) => {
      if (!u) throw 'Unable to find presentation root (<div class="reveal">).';
      if (b) throw "Reveal.js has already been initialized.";
      if (
        ((b = !0),
        (l.wrapper = u),
        (l.slides = u.querySelector(".slides")),
        !l.slides)
      )
        throw 'Unable to find slides container (<div class="slides">).';
      return (
        (o = { ...si, ...o, ...e, ...n, ...wt() }),
        /print-pdf/gi.test(window.location.search) && (o.view = "print"),
        (() => {
          o.embedded === !0
            ? (l.viewport = F(u, ".reveal-viewport") || u)
            : ((l.viewport = document.body),
              document.documentElement.classList.add("reveal-full-page")),
            l.viewport.classList.add("reveal-viewport");
        })(),
        window.addEventListener("load", oe, !1),
        Y.load(o.plugins, o.dependencies).then(Nt),
        new Promise((d) => t.on("ready", d))
      );
    },
    configure: Ue,
    destroy: () => {
      (b = !1),
        p !== !1 &&
          ...
          I.destroy(),
          U.destroy(),
          document.removeEventListener("fullscreenchange", Re),
          document.removeEventListener("webkitfullscreenchange", Re),
          document.removeEventListener("visibilitychange", yt, !1),
          window.removeEventListener("message", vt, !1),
          window.removeEventListener("load", oe, !1),
          l.pauseOverlay && l.pauseOverlay.remove(),
          l.statusElement && l.statusElement.remove(),
          ...
          l.wrapper.removeAttribute("data-transition-speed"),
          l.wrapper.removeAttribute("data-background-transition"),
          l.viewport.classList.remove("reveal-viewport"),
          l.viewport.style.removeProperty("--slide-width"),
          l.viewport.style.removeProperty("--slide-height"),
          l.slides.style.removeProperty("width"),
          l.slides.style.removeProperty("height"),
          l.slides.style.removeProperty("zoom"),
          l.slides.style.removeProperty("left"),
          l.slides.style.removeProperty("top"),
          l.slides.style.removeProperty("bottom"),
          l.slides.style.removeProperty("right"),
          l.slides.style.removeProperty("transform"),
          Array.from(l.wrapper.querySelectorAll(ne)).forEach((n) => {
    ...
    sync: tt,
    syncSlide: (n = r) => {
      L.sync(n), R.sync(n), A.load(n), L.update(), X.update();
    },
    ...
    toggleHelp: B.toggleHelp.bind(B),
    toggleOverview: P.toggle.bind(P),
    toggleScrollView: h.toggle.bind(h),
    togglePause: et,
    toggleAutoSlide: (n) => {
      typeof n == "boolean" ? (n ? we() : be()) : D ? we() : be();
    },
    toggleJumpToSlide: (n) => {
      typeof n == "boolean"
        ? n
    ...
    isFirstSlide: Qe,
    isLastSlide: Pe,
    isLastVerticalSlide: Ge,
    isVerticalSlide: ue,
    isVerticalStack: (n = r) =>
      n.classList.contains(".stack") || n.querySelector("section") !== null,
    isPaused: ve,
    isAutoSliding: () => !(!M || D),
    isSpeakerNotes: X.isSpeakerNotesWindow.bind(X),
    isOverview: P.isActive.bind(P),
    isFocused: se.isFocused.bind(se),
    isOverlayOpen: B.isOpen.bind(B),
    isScrollView: h.isActive.bind(h),
    isPrintView: S.isActive.bind(S),
    isReady: () => p,
    loadSlide: A.load.bind(A),
    unloadSlide: A.unload.bind(A),
    startEmbeddedContent: () => A.startEmbeddedContent(r),
    stopEmbeddedContent: () => A.stopEmbeddedContent(r, { unloadIframes: !1 }),
    previewIframe: B.previewIframe.bind(B),
    previewImage: B.previewImage.bind(B),
    previewVideo: B.previewVideo.bind(B),
    showPreview: B.previewIframe.bind(B),
    hidePreview: B.close.bind(B),
    addEventListeners: We,
    removeEventListeners: me,
    dispatchEvent: K,
    getState: ut,
    setState: (n) => {
      if (typeof n == "object") {
        _(de(n.indexh), de(n.indexv), de(n.indexf));
        const d = de(n.paused),
          v = de(n.overview);
        typeof d == "boolean" && d !== ve() && et(d),
          typeof v == "boolean" && v !== P.isActive() && P.toggle(v),
          B.setState(n);
      }
    },
    getProgress: () => {
      let n = ct(),
        d = rt();
      if (r) {
        const v = r.querySelectorAll(".fragment");
        v.length > 0 &&
          (d +=
            (r.querySelectorAll(".fragment.visible").length / v.length) * 0.9);
      }
    ...
    getSlidesAttributes: () =>
      Me().map((n) => {
        ...
        for (let v = 0; v < n.attributes.length; v++) {
          const m = n.attributes[v];
          d[m.name] = m.value;
        }
        return d;
      }),
    getSlidePastCount: rt,
    getTotalSlides: ct,
    getSlide: ht,
    getPreviousSlide: () => a,
    getCurrentSlide: () => r,
    getSlideBackground: (n, d) => {
      const v = typeof n == "number" ? ht(n, d) : n;
      if (v) return v.slideBackgroundElement;
    },
    getSlideNotes: X.getSlideNotes.bind(X),
    getSlides: Me,
    getHorizontalSlides: Z,
    ...
    addKeyBinding: z.addKeyBinding.bind(z),
    removeKeyBinding: z.removeKeyBinding.bind(z),
    triggerKey: z.triggerKey.bind(z),
    registerKeyboardShortcut: z.registerKeyboardShortcut.bind(z),
    getComputedSlideSize: fe,
    setCurrentScrollPage: (n, d, v) => {
      const m = i || 0;
      (i = d), (s = v);
      const y = r !== n;
      (a = r),
        (r = n),
        r && a && o.autoAnimate && Te(a, r, m, s) && W.run(a, r),
        y &&
          (a &&
            (A.stopEmbeddedContent(a),
            A.stopEmbeddedContent(a.slideBackgroundElement)),
          A.startEmbeddedContent(r),
          A.startEmbeddedContent(r.slideBackgroundElement)),
        requestAnimationFrame(() => {
          Ce(pe(r));
        }),
        $e();
    ...
    hasPlugin: Y.hasPlugin.bind(Y),
    getPlugin: Y.getPlugin.bind(Y),
    getPlugins: Y.getRegisteredPlugins.bind(Y),
  };
  return (
    ce(t, {
      ...bt,
      ...
      slideNumber: I,
      onUserInput: (n) => {
        o.autoSlideStoppable && be();
      },
      closeOverlay: B.close.bind(B),
      updateSlidesVisibility: Ie,
      layoutSlideContents: Ye,
      transformSlides: xe,
      cueAutoSlide: le,
      cancelAutoSlide: ye,
    }),
...
const re = Tt,
  kt = [];
(re.initialize = (u) => (
  Object.assign(re, new Tt(document.querySelector(".reveal"), u)),
  kt.map((e) => e(re)),
  re.initialize()
)),
  [
