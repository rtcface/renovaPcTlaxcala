...
const j = /[&<>"']/,
  X = new RegExp(j.source, "g"),
  Q = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  G = new RegExp(Q.source, "g"),
  tt = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  D = (h) => tt[h];
function b(h, n) {
  if (n) {
    if (j.test(h)) return h.replace(X, D);
  } else if (Q.test(h)) return h.replace(G, D);
  return h;
}
const et = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
function W(h) {
  return h.replace(et, (n, t) =>
...
const nt = /(^|[^[])\^/g;
function k(h, n) {
  (h = typeof h == "string" ? h : h.source), (n = n || "");
  const t = {
    replace: (e, s) => (
      (s = (s = s.source || s).replace(nt, "$1")), (h = h.replace(e, s)), t
    ),
    getRegex: () => new RegExp(h, n),
  };
  return t;
}
const st = /[^\w:]/g,
...
function U(h, n, t) {
  if (h) {
    let e;
    try {
      e = decodeURIComponent(W(t)).replace(st, "").toLowerCase();
    } catch {
      return null;
    }
    if (
...
function M(h, n, t) {
  ...
  let s = 0;
  for (; s < e; ) {
    const a = h.charAt(e - s - 1);
    if (a !== n || t) {
      if (a === n || !t) break;
      s++;
    } else s++;
  }
  return h.slice(0, e - s);
}
function H(h, n) {
  if (n < 1) return "";
  let t = "";
  for (; n > 1; ) 1 & n && (t += h), (n >>= 1), (h += h);
  return t + h;
}
function B(h, n, t, e) {
  const s = n.href,
    a = n.title ? b(n.title) : null,
    r = h[1].replace(/\\([[\]])/g, "$1");
  if (h[0].charAt(0) !== "!") {
    e.state.inLink = !0;
    const i = {
  ...
  return { type: "image", raw: t, href: s, title: a, text: b(r) };
}
class P {
  constructor(n) {
    this.options = n || E;
...
`)
            .map((c) => {
              ...
              if (d === null) return c;
              const [l] = d;
              return l.length >= o.length ? c.slice(o.length) : c;
            })
            .join(`
`);
        })(e, t[3] || "");
  ...
  blockquote(n) {
    ...
    if (t) {
      ...
      const a = this.lexer.blockTokens(e);
      return (
        (this.lexer.state.top = s),
        { type: "blockquote", raw: t[0], tokens: a, text: e }
      );
    }
  }
  list(n) {
    ...
    if (t) {
      ...
      (y = T ? `\\d{1,9}\\${y.slice(-1)}` : `\\${y}`),
        this.options.pedantic && (y = T ? y : "[*+-]");
      const A = new RegExp(`^( {0,3}${y})((?:[	 ][^\\n]*)?(?:\\n|$))`);
      for (
        ;
        n && ((S = !1), (t = A.exec(n))) && !this.rules.block.hr.test(n);
      ) {
        if (
          ((e = t[0]),
...
`),
      ...
      (f.items[f.items.length - 1].raw = e.trimRight()),
        (f.items[f.items.length - 1].text = w.trimRight()),
        (f.raw = f.raw.trimRight());
      const L = f.items.length;
      for (i = 0; i < L; i++)
        if (
          ((this.lexer.state.top = !1),
          (f.items[i].tokens = this.lexer.blockTokens(f.items[i].text, [])),
          !f.loose)
        ) {
          const v = f.items[i].tokens.filter((x) => x.type === "space"),
            _ = v.length > 0 && v.some((x) => /\n.*\n/.test(x.raw));
          f.loose = _;
        }
      if (f.loose) for (i = 0; i < L; i++) f.items[i].loose = !0;
      return f;
    }
  }
  html(n) {
      ...
      const e = t[1].toLowerCase().replace(/\s+/g, " "),
        ...
        a = t[3]
          ? t[3]
              ...
              .replace(this.rules.inline._escapes, "$1")
          : t[3];
      return { type: "def", tag: e, raw: t[0], href: s, title: a };
    }
  }
  table(n) {
...
`)
      ...
      if (e.header.length === e.align.length) {
        ...
        for (o = e.rows.length, s = 0; s < o; s++)
          e.rows[s] = Z(e.rows[s], e.header.length).map((c) => ({ text: c }));
        for (o = e.header.length, a = 0; a < o; a++)
          e.header[a].tokens = this.lexer.inline(e.header[a].text);
        for (o = e.rows.length, a = 0; a < o; a++)
          for (i = e.rows[a], r = 0; r < i.length; r++)
...
`
  ...
  escape(n) {
    ...
    if (t) return { type: "escape", raw: t[0], text: b(t[1]) };
  }
  tag(n) {
  ...
  link(n) {
    ...
    if (t) {
      ...
      if (!this.options.pedantic && /^</.test(e)) {
        if (!/>$/.test(e)) return;
        const r = M(e.slice(0, -1), "\\");
        if ((e.length - r.length) % 2 == 0) return;
      } else {
        const r = ((i, o) => {
          if (i.indexOf(o[1]) === -1) return -1;
          const c = i.length;
          let d = 0,
            l = 0;
          for (; l < c; l++)
            ...
            else if (i[l] === o[1] && (d--, d < 0)) return l;
          return -1;
        })(t[2], "()");
        if (r > -1) {
          const i = (t[0].indexOf("!") === 0 ? 5 : 4) + t[1].length + r;
  ...
  emStrong(n, t, e = "") {
    ...
    const a = s[1] || s[2] || "";
    if (!a || (a && (e === "" || this.rules.inline.punctuation.exec(e)))) {
      ...
      for (
        l.lastIndex = 0, t = t.slice(-1 * n.length + r);
        (s = l.exec(t)) != null;
      ) {
        ...
        if ((s[5] || s[6]) && r % 3 && !((r + o) % 3)) {
          d += o;
          continue;
        }
        if (((c -= o), c > 0)) continue;
        o = Math.min(o, o + c + d);
        const u = n.slice(0, r + s.index + (s[0].length - i.length) + o);
        if (Math.min(r, o) % 2) {
          const S = u.slice(1, -1);
          return {
            type: "em",
  ...
  codespan(n) {
    ...
    if (t) {
      ...
      const s = /[^ ]/.test(e),
        a = /^ /.test(e) && / $/.test(e);
      return (
        s && a && (e = e.substring(1, e.length - 1)),
        (e = b(e, !0)),
  ...
  autolink(n, t) {
    ...
    if (e) {
      ...
      return (
        e[2] === "@"
          ? ((s = b(this.options.mangle ? t(e[1]) : e[1])), (a = "mailto:" + s))
          : ((s = b(e[1])), (a = s)),
        {
          type: "link",
          raw: e[0],
  ...
  url(n, t) {
    ...
    if ((e = this.rules.inline.url.exec(n))) {
      let s, a;
      if (e[2] === "@")
        (s = b(this.options.mangle ? t(e[0]) : e[0])), (a = "mailto:" + s);
      else {
        let r;
        do (r = e[0]), (e[0] = this.rules.inline._backpedal.exec(e[0])[0]);
        while (r !== e[0]);
        (s = b(e[0])), (a = e[1] === "www." ? "http://" + e[0] : e[0]);
      }
      return {
        type: "link",
        raw: e[0],
        ...
        (s = this.lexer.state.inRawBlock
          ? this.options.sanitize
            ? this.options.sanitizer
              ...
              : b(e[0])
            : e[0]
          : b(this.options.smartypants ? t(e[0]) : e[0])),
...
(m.def = k(m.def)
  ...
  (m.gfm.table = k(m.gfm.table)
    ...
    .replace("tag", m._tag)
    .getRegex()),
  (m.gfm.paragraph = k(m._paragraph)
    .replace("hr", m.hr)
    .replace("heading", " {0,3}#{1,6} ")
    .replace("|lheading", "")
  ...
  (m.pedantic = {
    ...
    fences: C,
    lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
    paragraph: k(m.normal._paragraph)
      .replace("hr", m.hr)
      .replace(
        "heading",
        ` *#{1,6} *[^
...
(p._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
  ...
  (p.blockSkip = /\[[^\]]*?\]\([^)]*?\)|`[^`]*?`|<[^>]*?>/g),
  (p.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
  (p._comment = k(m._comment).replace("(?:-->|$)", "-->").getRegex()),
  ...
  (p.reflink = k(p.reflink)
    ...
    .getRegex()),
  (p.nolink = k(p.nolink).replace("ref", m._label).getRegex()),
...
class z {
  constructor(n) {
    (this.tokens = []),
      ...
      (this.options = n || E),
      (this.options.tokenizer = this.options.tokenizer || new P()),
      (this.tokenizer = this.options.tokenizer),
      (this.tokenizer.options = this.options),
      (this.tokenizer.lexer = this),
      (this.inlineQueue = []),
      (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
    const t = { block: m.normal, inline: p.normal };
    this.options.pedantic
      ? ((t.block = m.pedantic), (t.inline = p.pedantic))
      : this.options.gfm &&
        ((t.block = m.gfm),
  ...
  static get rules() {
    return { block: m, inline: p };
  }
  static lex(n, t) {
    return new z(t).lex(n);
  }
  static lexInline(n, t) {
    return new z(t).inlineTokens(n);
  }
  lex(n) {
    let t;
    for (
  ...
  blockTokens(n, t = []) {
    ...
    for (
      n = this.options.pedantic
        ...
        : n.replace(/^( *)(\t+)/gm, (i, o, c) => o + "    ".repeat(c.length));
      n;
    )
      if (
        !(
...
` + e.raw),
          ...
          if (
            ...
            this.options.extensions.startBlock.forEach(function (d) {
              (c = d.call({ lexer: this }, o)),
                typeof c == "number" && c >= 0 && (i = Math.min(i, c));
            }),
              i < 1 / 0 && i >= 0 && (a = n.substring(0, i + 1));
          }
...
` + e.text),
            ...
            const i = "Infinite loop on byte: " + n.charCodeAt(0);
  ...
  inlineTokens(n, t = []) {
    ...
    if (this.tokens.links) {
      ...
      if (d.length > 0)
        for (
          ;
          (r = this.tokenizer.rules.inline.reflinkSearch.exec(c)) != null;
        )
          d.includes(r[0].slice(r[0].lastIndexOf("[") + 1, -1)) &&
            (c =
              c.slice(0, r.index) +
              "[" +
              H("a", r[0].length - 2) +
    ...
    for (; (r = this.tokenizer.rules.inline.blockSkip.exec(c)) != null; )
      c =
        c.slice(0, r.index) +
        "[" +
        H("a", r[0].length - 2) +
    ...
    for (; (r = this.tokenizer.rules.inline.escapedEmSt.exec(c)) != null; )
      (c =
        c.slice(0, r.index + r[0].length - 2) +
        "++" +
        ...
        if ((e = this.tokenizer.escape(n)))
          ...
          (n = n.substring(e.raw.length)),
            ...
            s && e.type === "text" && s.type === "text"
              ? ((s.raw += e.raw), (s.text += e.text))
              : t.push(e);
        else if ((e = this.tokenizer.emStrong(n, c, o)))
          (n = n.substring(e.raw.length)), t.push(e);
          ...
          if (
            ...
            const l = n.slice(1);
            let u;
            this.options.extensions.startInline.forEach(function (w) {
              (u = w.call({ lexer: this }, l)),
                typeof u == "number" && u >= 0 && (d = Math.min(d, u));
            }),
              d < 1 / 0 && d >= 0 && (a = n.substring(0, d + 1));
          }
          if ((e = this.tokenizer.inlineText(a, lt)))
            (n = n.substring(e.raw.length)),
              e.raw.slice(-1) !== "_" && (o = e.raw.slice(-1)),
              (i = !0),
              (s = t[t.length - 1]),
              s && s.type === "text"
                ? ((s.raw += e.raw), (s.text += e.text))
...
class O {
  ...
  code(n, t, e) {
    ...
    if (this.options.highlight) {
      const a = this.options.highlight(n, s);
      a != null && a !== n && ((e = !0), (n = a));
    }
    return (
      (n =
...
`
  ...
  link(n, t, e) {
    if ((n = U(this.options.sanitize, this.options.baseUrl, n)) === null)
      return e;
    let s = '<a href="' + n + '"';
...
class $ {
  ...
  static parse(n, t) {
    return new $(t).parse(n);
  }
  static parseInline(n, t) {
    return new $(t).parseInline(n);
  }
  parse(n, t = !0) {
    let e,
      s,
        ...
        switch (u.type) {
          ...
          case "heading":
            x += this.renderer.heading(
              ...
              u.depth,
              W(this.parseInline(u.tokens, this.textRenderer)),
              this.slugger,
            );
            continue;
          case "code":
            ...
            continue;
          case "table":
            for (d = "", c = "", r = u.header.length, s = 0; s < r; s++)
              c += this.renderer.tablecell(
                this.parseInline(u.header[s].tokens),
                { header: !0, align: u.align[s] },
              );
            for (
              d += this.renderer.tablerow(c), l = "", r = u.rows.length, s = 0;
              s < r;
              s++
            ) {
              for (o = u.rows[s], c = "", i = o.length, a = 0; a < i; a++)
                c += this.renderer.tablecell(this.parseInline(o[a].tokens), {
                  header: !1,
                  align: u.align[a],
                });
              l += this.renderer.tablerow(c);
            }
            x += this.renderer.table(d, l);
            continue;
          case "blockquote":
            (l = this.parse(u.tokens)), (x += this.renderer.blockquote(l));
            continue;
          case "list":
            for (
              w = u.ordered,
              ...
              (f = u.items[s]),
                ...
                (T = ""),
                f.task &&
                  ((v = this.renderer.checkbox(A)),
                  y
                    ? f.tokens.length > 0 && f.tokens[0].type === "paragraph"
                      ? ((f.tokens[0].text = v + " " + f.tokens[0].text),
                        f.tokens[0].tokens &&
                          f.tokens[0].tokens.length > 0 &&
                          f.tokens[0].tokens[0].type === "text" &&
                          (f.tokens[0].tokens[0].text =
                            v + " " + f.tokens[0].tokens[0].text))
                      : f.tokens.unshift({ type: "text", text: v })
                    : (T += v)),
                (T += this.parse(f.tokens, y)),
                (l += this.renderer.listitem(T, L, A));
            x += this.renderer.list(l, w, S);
            continue;
          case "html":
...
` + (u.tokens ? this.parseInline(u.tokens) : u.text));
            ...
            continue;
          default: {
            const N = 'Token with "' + u.type + '" type was not found.';
...
Please report this to https://github.com/markedjs/marked.`),
          ...
          const l =
            "<p>An error occurred:</p><pre>" + b(d.message + "", !0) + "</pre>";
          return o ? Promise.resolve(l) : c ? void c(null, l) : l;
        }
        if (o) return Promise.reject(d);
        if (!c) throw d;
        c(d);
      })((e = { ...g.defaults, ...a }).silent, e.async, s);
    if (t == null)
    ...
    if (
      ...
      let o;
      try {
        e.hooks && (t = e.hooks.preprocess(t)), (o = h(t, e));
      } catch (l) {
        return r(l);
      }
      const c = (l) => {
        ...
        if (!l)
          try {
            e.walkTokens && g.walkTokens(o, e.walkTokens),
              (u = n(o, e)),
              e.hooks && (u = e.hooks.postprocess(u));
          } catch (w) {
            l = w;
          }
        return (e.highlight = i), l ? r(l) : s(null, u);
      };
      if (!i || i.length < 3 || (delete e.highlight, !o.length)) return c();
      let d = 0;
      return (
        g.walkTokens(o, (l) => {
          l.type === "code" &&
            ...
            setTimeout(() => {
              i(l.text, l.lang, (u, w) => {
                if (u) return c(u);
                w != null && w !== l.text && ((l.text = w), (l.escaped = !0)),
                  d--,
                  d === 0 && c();
              });
            }, 0));
    ...
    if (e.async)
      return Promise.resolve(e.hooks ? e.hooks.preprocess(t) : t)
        ...
        .then((i) =>
          e.walkTokens
            ? Promise.all(g.walkTokens(i, e.walkTokens)).then(() => i)
            : i,
        )
        .then((i) => n(i, e))
        .then((i) => (e.hooks ? e.hooks.postprocess(i) : i))
        .catch(r);
    try {
      e.hooks && (t = e.hooks.preprocess(t));
      const i = h(t, e);
      e.walkTokens && g.walkTokens(i, e.walkTokens);
      let o = n(i, e);
...
(g.options = g.setOptions =
  (h) => {
    var n;
    return (g.defaults = { ...g.defaults, ...h }), (n = g.defaults), (E = n), g;
  }),
  (g.getDefaults = Y),
  (g.defaults = E),
  (g.use = (...h) => {
    ...
    h.forEach((t) => {
      ...
      if (
        ...
        const s = g.defaults.renderer || new O();
        for (const a in t.renderer) {
          const r = s[a];
          s[a] = (...i) => {
            let o = t.renderer[a].apply(s, i);
            return o === !1 && (o = r.apply(s, i)), o;
          };
        }
        e.renderer = s;
      }
      if (t.tokenizer) {
        const s = g.defaults.tokenizer || new P();
        for (const a in t.tokenizer) {
          const r = s[a];
          s[a] = (...i) => {
            let o = t.tokenizer[a].apply(s, i);
            return o === !1 && (o = r.apply(s, i)), o;
          };
        }
        e.tokenizer = s;
      ...
      if (t.hooks) {
        const s = g.defaults.hooks || new q();
        for (const a in t.hooks) {
          const r = s[a];
          q.passThroughHooks.has(a)
            ? (s[a] = (i) => {
                if (g.defaults.async)
                  return Promise.resolve(t.hooks[a].call(s, i)).then((c) =>
                    r.call(s, c),
                  );
                const o = t.hooks[a].call(s, i);
                return r.call(s, o);
              })
            : (s[a] = (...i) => {
                let o = t.hooks[a].apply(s, i);
                return o === !1 && (o = r.apply(s, i)), o;
              });
        }
        e.hooks = s;
      ...
      if (t.walkTokens) {
        const s = g.defaults.walkTokens;
        e.walkTokens = function (a) {
          let r = [];
          return (
            r.push(t.walkTokens.call(this, a)),
            s && (r = r.concat(s.call(this, a))),
            r
          );
        };
      }
  ...
  (g.walkTokens = (h, n) => {
    ...
    for (const e of h)
      switch (((t = t.concat(n.call(g, e))), e.type)) {
        case "table":
          for (const s of e.header) t = t.concat(g.walkTokens(s.tokens, n));
          for (const s of e.rows)
            for (const a of s) t = t.concat(g.walkTokens(a.tokens, n));
          break;
        case "list":
        ...
        default:
          ...
          g.defaults.extensions.childTokens[e.type]
            ? g.defaults.extensions.childTokens[e.type].forEach((s) => {
                t = t.concat(g.walkTokens(e[s], n));
              })
            : e.tokens && (t = t.concat(g.walkTokens(e.tokens, n)));
      }
    return t;
  }),
  (g.parseInline = F(z.lexInline, $.parseInline)),
  (g.Parser = $),
  (g.parser = $.parse),
  (g.Renderer = O),
  (g.TextRenderer = K),
...
<html lang="en">
  ...
  function s(i) {
    let o = n.getCurrentSlide(),
      c = o.querySelectorAll("aside.notes"),
      d = o.querySelector(".current-fragment"),
      l = {
        namespace: "reveal-notes",
        type: "state",
        notes: "",
    ...
    if (
      (o.hasAttribute("data-notes") &&
        ((l.notes = o.getAttribute("data-notes")), (l.whitespace = "pre-wrap")),
      d)
    ) {
      const u = d.querySelector("aside.notes");
      u
        ? ((l.notes = u.innerHTML),
          (l.markdown = typeof u.getAttribute("data-markdown") == "string"),
          (c = null))
        : d.hasAttribute("data-notes") &&
          ((l.notes = d.getAttribute("data-notes")),
          (l.whitespace = "pre-wrap"),
          (c = null));
    }
    c &&
      c.length &&
      ((c = Array.from(c).filter((u) => u.closest(".fragment") === null)),
      (l.notes = c
        .map((u) => u.innerHTML)
        .join(`
`)),
      (l.markdown =
        c[0] && typeof c[0].getAttribute("data-markdown") == "string")),
  ...
  function a(i) {
    if (
      ((o) => {
        try {
          return window.location.origin === o.source.location.origin;
        } catch {
          return !1;
        }
      })(i)
      ...
      try {
        ...
        o && o.namespace === "reveal-notes" && o.type === "connected"
          ? (clearInterval(h), r())
          : o &&
            o.namespace === "reveal-notes" &&
            o.type === "call" &&
            ((c, d, l) => {
              const u = n[c].apply(n, d);
              t.postMessage(
                JSON.stringify({
                  namespace: "reveal-notes",
                  type: "return",
            ...
            })(o.methodName, o.arguments, o.callId);
      } catch {}
  }
  function r() {
    n.on("slidechanged", s),
        ...
        /receiver/i.test(window.location.search) ||
          (window.location.search.match(/(\?|&)notes/gi) !== null
            ...
            : window.addEventListener("message", (o) => {
                if (!t && typeof o.data == "string") {
                  let d;
                  try {
                    d = JSON.parse(o.data);
                  } catch {}
                  d &&
                    d.namespace === "reveal-notes" &&
                    d.type === "heartbeat" &&
                    ((c = o.source),
                    t && !t.closed
                      ? t.focus()
                      : ((t = c), window.addEventListener("message", a), r()));
                }
                var c;
              }),
          n.addKeyBinding(
