import { R as Ut } from "./index.BoFeahe5.js";
import { R as a } from "./index.CY-HDqYb.js";
    ...
    (this.subscribe = (o) => (
      ...
      (this.create = (o) => {
        ...
        const { message: s, ...C } = o,
          u =
            typeof o?.id == "number" ||
            ((e = o.id) == null ? void 0 : e.length) > 0
              ? o.id
              : xt++,
          g = this.toasts.find((b) => b.id === u),
          _ = o.dismissible === void 0 ? !0 : o.dismissible;
        return (
          this.dismissedToasts.has(u) && this.dismissedToasts.delete(u),
          g
            ? (this.toasts = this.toasts.map((b) =>
                b.id === u
                  ? (this.publish({ ...b, ...o, id: u, title: s }),
                    { ...b, ...o, id: u, dismissible: _, title: s })
                  : b,
              ))
            : this.addToast({ title: s, ...C, dismissible: _, id: u }),
          u
        );
      }),
      (this.dismiss = (o) => (
        o
          ? (this.dismissedToasts.add(o),
            requestAnimationFrame(() =>
              this.subscribers.forEach((e) => e({ id: o, dismiss: !0 })),
            ))
      ...
      (this.message = (o, e) => this.create({ ...e, message: o })),
      (this.error = (o, e) => this.create({ ...e, message: o, type: "error" })),
      (this.success = (o, e) =>
        this.create({ ...e, type: "success", message: o })),
      (this.info = (o, e) => this.create({ ...e, type: "info", message: o })),
      (this.warning = (o, e) =>
        this.create({ ...e, type: "warning", message: o })),
      (this.loading = (o, e) =>
        this.create({ ...e, type: "loading", message: o })),
      (this.promise = (o, e) => {
        if (!e) return;
        let s;
        e.loading !== void 0 &&
        ...
        const _ = C.then(async (i) => {
            if (((g = ["resolve", i]), a.isValidElement(i)))
              (u = !1), this.create({ id: s, type: "default", message: i });
            else if (se(i) && !i.ok) {
              u = !1;
              const t =
                ...
                x =
                  typeof e.description == "function"
                    ...
                    : e.description,
                E =
                  typeof t == "object" && !a.isValidElement(t)
                    ? t
                    : { message: t };
              this.create({ id: s, type: "error", description: x, ...E });
              ...
              const t =
                ...
                E =
                  typeof t == "object" && !a.isValidElement(t)
                    ? t
                    : { message: t };
              this.create({ id: s, type: "success", description: x, ...E });
            }
          })
            .catch(async (i) => {
                ...
                const T =
                  ...
                  O =
                    typeof T == "object" && !a.isValidElement(T)
                      ? T
                      : { message: T };
                this.create({ id: s, type: "error", description: t, ...O });
              }
            })
            .finally(() => {
          ...
          b = () =>
            new Promise((i, T) =>
              _.then(() => (g[0] === "reject" ? T(g[1]) : i(g[1]))).catch(T),
            );
...
const he = (r) => {
  ...
  const {
    ...
    ct = a.useMemo(
      () => U.findIndex((n) => n.toastId === t.id) || 0,
      [U, t.id],
    ),
    jt = a.useMemo(() => {
      var n;
    ...
    St = a.useMemo(() => t.duration || tt || Mt, [t.duration, tt]),
    yt = a.useRef(0),
    Q = a.useRef(0),
    Nt = a.useRef(0),
    J = a.useRef(null),
    [Lt, Yt] = A.split("-"),
    kt = a.useMemo(
      () => U.reduce((n, h, w) => (w >= ct ? n : n + h.height), 0),
      [U, ct],
    ),
    _t = ee(),
    $t = t.invert || T,
    wt = N === "loading";
  (Q.current = a.useMemo(() => ct * rt + kt, [ct, kt])),
    a.useEffect(() => {
      at.current = St;
    }, [St]),
    a.useEffect(() => {
    ...
    a.useEffect(() => {
      ...
      if (n) {
        ...
        return (
          Et(h),
          E((w) => [{ toastId: t.id, height: h, position: t.position }, ...w]),
    ...
    a.useLayoutEffect(() => {
      ...
      (n.style.height = h),
        Et(w),
        E((k) =>
          k.find((y) => y.toastId === t.id)
            ? k.map((y) => (y.toastId === t.id ? { ...y, height: w } : y))
            : [{ toastId: t.id, height: w, position: t.position }, ...k],
        );
    }, [l, t.title, t.description, E, t.id, t.jsx, t.action, t.cancel]);
  const L = a.useCallback(() => {
    R(!0),
      vt(Q.current),
      E((n) => n.filter((h) => h.toastId !== t.id)),
      setTimeout(() => {
        st(t);
      }, pe);
  }, [t, st, E, Q]);
      ...
      X || O || _t
        ? (() => {
            if (Nt.current < yt.current) {
              const k = new Date().getTime() - yt.current;
  ...
  function Ft() {
    ...
    if (v?.loading) {
      ...
      return a.createElement(
        "div",
        {
          className: H(
            c?.loader,
            t == null || (h = t.classNames) == null ? void 0 : h.loader,
            "sonner-loader",
          ),
    ...
    return a.createElement(qt, {
      className: H(
        c?.loader,
        t == null || (n = t.classNames) == null ? void 0 : n.loader,
      ),
      visible: N === "loading",
    });
  }
  ...
  return a.createElement(
    "li",
    {
      ...
      className: H(
        ...
        c?.default,
        c?.[N],
        t == null || (e = t.classNames) == null ? void 0 : e[N],
      ),
      "data-sonner-toast": "",
        ...
        n.button !== 2 &&
          (wt ||
            ...
            n.target.tagName !== "BUTTON" &&
              (f(!0), (J.current = { x: n.clientX, y: n.clientY }))));
      },
      onPointerUp: () => {
        var n, h, w;
        if (K || !G) return;
        ...
        const k = Number(
          ...
          y =
            new Date().getTime() -
            ((w = Tt.current) == null ? void 0 : w.getTime()),
          D = $ === "x" ? k : ut,
          ft = Math.abs(D) / y;
        if (Math.abs(D) >= me || ft > 0.11) {
          vt(Q.current),
            t.onDismiss == null || t.onDismiss.call(t, t),
            it($ === "x" ? (k > 0 ? "right" : "left") : ut > 0 ? "down" : "up"),
            L(),
            lt(!0);
          return;
        } else {
          var M, I;
          (M = P.current) == null ||
            M.style.setProperty("--swipe-amount-x", "0px"),
            (I = P.current) == null ||
      ...
      onPointerMove: (n) => {
        ...
        if (
          !J.current ||
          !G ||
          ((h = window.getSelection()) == null ? void 0 : h.toString().length) >
            0
        )
          return;
        const y = n.clientY - J.current.y,
          D = n.clientX - J.current.x;
        var ft;
        const M = (ft = r.swipeDirections) != null ? ft : ge(A);
        !$ &&
          (Math.abs(D) > 1 || Math.abs(y) > 1) &&
          B(Math.abs(D) > Math.abs(y) ? "x" : "y");
        const I = { x: 0, y: 0 };
        ...
        (Math.abs(I.x) > 0 || Math.abs(I.y) > 0) && q(!0),
          (w = P.current) == null ||
            w.style.setProperty("--swipe-amount-x", `${I.x}px`),
          (k = P.current) == null ||
            k.style.setProperty("--swipe-amount-y", `${I.y}px`);
      },
    },
    jt && !t.jsx && N !== "loading"
      ? a.createElement(
          ...
          (Dt = v?.close) != null ? Dt : te,
        )
      : null,
    (N || t.icon || t.promise) && t.icon !== null && (v?.[N] !== null || t.icon)
      ? a.createElement(
          "div",
          {
            "data-icon": "",
              ...
              onClick: (n) => {
                mt(t.cancel) &&
                  ...
                  (t.cancel.onClick == null ||
                    t.cancel.onClick.call(t.cancel, n),
                  L());
              },
              className: H(
                c?.cancelButton,
              ...
              onClick: (n) => {
                mt(t.action) &&
                  (t.action.onClick == null ||
                    t.action.onClick.call(t.action, n),
...
const Ee = a.forwardRef((o, e) => {
  const {
    ...
    Y = a.useMemo(
      () =>
        s ? z.filter((l) => l.toasterId === s) : z.filter((l) => !l.toasterId),
      [z, s],
    ),
    ht = a.useMemo(
      () =>
        Array.from(
          new Set(
            [u].concat(Y.filter((l) => l.position).map((l) => l.position)),
          ),
        ),
      [Y, u],
    ),
    ...
    j = a.useRef(null),
    $ = g.join("+").replace(/Key/g, "").replace(/Digit/g, ""),
    B = a.useRef(null),
    F = a.useRef(!1),
    it = a.useCallback((l) => {
      Z((p) => {
        var m;
        return (
          ((m = p.find((R) => R.id === l.id)) != null && m.delete) ||
            S.dismiss(l.id),
          p.filter(({ id: R }) => R !== l.id)
        );
      });
    }, []);
  return (
      ...
      () =>
        S.subscribe((l) => {
          if (l.dismiss) {
            requestAnimationFrame(() => {
              Z((p) =>
                p.map((m) => (m.id === l.id ? { ...m, delete: !0 } : m)),
              );
            });
            return;
          }
      ...
      const l = (p) => {
        ...
        p.code === "Escape" &&
          (document.activeElement === j.current ||
            ((m = j.current) != null && m.contains(document.activeElement))) &&
          A(!1);
      };
      return (
      ...
      ht.map((l, p) => {
        ...
        return Y.length
          ? a.createElement(
              "ol",
              {
                ...
                onFocus: (f) => {
                  (f.target instanceof HTMLElement &&
                    f.target.dataset.dismissible === "false") ||
                    F.current ||
                    ((F.current = !0), (B.current = f.relatedTarget));
                },
                onMouseEnter: () => A(!0),
                onMouseMove: () => A(!0),
                onMouseLeave: () => {
              ...
              Y.filter((f) => (!f.position && p === 0) || f.position === l).map(
                (f, K) => {
                  var lt, dt;
