import { a as O } from "./index.CY-HDqYb.js";
  ...
  return (
    ...
    (n.preinit = (r, e) => {
      if (typeof r == "string" && e && typeof e.as == "string") {
        var t = e.as,
          c = d(t, e.crossOrigin),
          s = typeof e.integrity == "string" ? e.integrity : void 0,
    ...
    (n.useFormState = (r, e, t) => f.H.useFormState(r, e, t)),
    (n.useFormStatus = () => f.H.useHostTransitionStatus()),
    (n.version = "19.1.1"),
    n
  );
}
